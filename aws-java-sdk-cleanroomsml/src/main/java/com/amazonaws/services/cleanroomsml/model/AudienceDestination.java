 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanroomsml-2023-09-06/AudienceDestination" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AudienceDestination implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private S3ConfigMap s3Destination;
     ...
     * </p>
     * 
     * @return The Amazon S3 bucket and path for the configured audience.
     */

    public S3ConfigMap getS3Destination() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AudienceDestination == false)
            return false;
        AudienceDestination other = (AudienceDestination) obj;
    ...
    public AudienceDestination clone() {
        try {
            return (AudienceDestination) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cleanroomsml.model.transform.AudienceDestinationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
