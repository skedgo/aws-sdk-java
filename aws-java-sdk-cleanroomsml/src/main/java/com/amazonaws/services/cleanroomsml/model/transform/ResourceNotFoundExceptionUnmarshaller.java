...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.cleanroomsml.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.cleanroomsml.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cleanroomsml.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.cleanroomsml.model.ResourceNotFoundException(
                null);
