...
public class UpdateEventBusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateEventBusRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public UpdateEventBusRequest withKmsKeyIdentifier(String kmsKeyIdentifier) {
    ...
    public UpdateEventBusRequest withDescription(String description) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateEventBusRequest == false)
            return false;
    ...
    @Override
    public UpdateEventBusRequest clone() {
        return (UpdateEventBusRequest) super.clone();
    }
