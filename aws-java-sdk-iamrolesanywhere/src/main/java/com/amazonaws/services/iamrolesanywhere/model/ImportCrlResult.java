...
public class ImportCrlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportCrlResult == false)
            return false;
        ImportCrlResult other = (ImportCrlResult) obj;
    ...
    @Override
    public ImportCrlResult clone() {
        try {
            return (ImportCrlResult) super.clone();
