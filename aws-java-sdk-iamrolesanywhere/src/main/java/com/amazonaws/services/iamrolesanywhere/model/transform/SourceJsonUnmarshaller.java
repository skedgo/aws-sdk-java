        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("sourceData", targetDepth)) {
                    context.nextToken();
                    source.setSourceData(SourceDataJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("sourceType", targetDepth)) {
                    context.nextToken();
                    source.setSourceType(context.getUnmarshaller(String.class).unmarshall(context));
                }
