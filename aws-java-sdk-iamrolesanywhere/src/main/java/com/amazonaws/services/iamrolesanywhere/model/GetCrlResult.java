...
public class GetCrlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCrlResult == false)
            return false;
        GetCrlResult other = (GetCrlResult) obj;
    ...
    public GetCrlResult clone() {
        try {
            return (GetCrlResult) super.clone();
