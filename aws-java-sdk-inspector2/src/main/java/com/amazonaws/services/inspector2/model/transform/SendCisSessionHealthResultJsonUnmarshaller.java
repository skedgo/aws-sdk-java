...
/**
 * SendCisSessionHealthResult JSON Unmarshaller
 */
...
public class SendCisSessionHealthResultJsonUnmarshaller implements Unmarshaller<SendCisSessionHealthResult, JsonUnmarshallerContext> {
    ...
    public SendCisSessionHealthResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SendCisSessionHealthResult sendCisSessionHealthResult = new SendCisSessionHealthResult();

        return sendCisSessionHealthResult;
    }
