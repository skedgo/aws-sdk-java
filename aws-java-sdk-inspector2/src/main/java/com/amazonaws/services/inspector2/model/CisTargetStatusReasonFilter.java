 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/inspector2-2020-06-08/CisTargetStatusReasonFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CisTargetStatusReasonFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The comparison value of the CIS target status reason filter.
     * @see CisTargetStatusComparison
     */
     ...
     * </p>
     * 
     * @return The value of the CIS target status reason filter.
     * @see CisTargetStatusReason
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CisTargetStatusReasonFilter == false)
            return false;
        CisTargetStatusReasonFilter other = (CisTargetStatusReasonFilter) obj;
    ...
    public CisTargetStatusReasonFilter clone() {
        try {
            return (CisTargetStatusReasonFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.inspector2.model.transform.CisTargetStatusReasonFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
