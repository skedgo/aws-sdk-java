        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("day", targetDepth)) {
                    context.nextToken();
                    monthlySchedule.setDay(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("startTime", targetDepth)) {
                    context.nextToken();
                    monthlySchedule.setStartTime(TimeJsonUnmarshaller.getInstance().unmarshall(context));
                }
