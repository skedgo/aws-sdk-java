...
public class DeleteCisScanConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteCisScanConfigurationResult == false)
            return false;
        DeleteCisScanConfigurationResult other = (DeleteCisScanConfigurationResult) obj;
    ...
    public DeleteCisScanConfigurationResult clone() {
        try {
            return (DeleteCisScanConfigurationResult) super.clone();
