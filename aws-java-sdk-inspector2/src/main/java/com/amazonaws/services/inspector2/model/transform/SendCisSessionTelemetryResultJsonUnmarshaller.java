...
/**
 * SendCisSessionTelemetryResult JSON Unmarshaller
 */
...
public class SendCisSessionTelemetryResultJsonUnmarshaller implements Unmarshaller<SendCisSessionTelemetryResult, JsonUnmarshallerContext> {
    ...
    public SendCisSessionTelemetryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SendCisSessionTelemetryResult sendCisSessionTelemetryResult = new SendCisSessionTelemetryResult();

        return sendCisSessionTelemetryResult;
    }
