...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.docdbelastic.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.docdbelastic.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.docdbelastic.model.InternalServerException internalServerException = new com.amazonaws.services.docdbelastic.model.InternalServerException(
                null);
