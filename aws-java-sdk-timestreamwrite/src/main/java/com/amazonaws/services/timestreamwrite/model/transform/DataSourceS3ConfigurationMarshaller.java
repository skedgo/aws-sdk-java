...
/**
 * DataSourceS3ConfigurationMarshaller
 */
...
public class DataSourceS3ConfigurationMarshaller {
    ...
    public void marshall(DataSourceS3Configuration dataSourceS3Configuration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dataSourceS3Configuration.getBucketName(), BUCKETNAME_BINDING);
            protocolMarshaller.marshall(dataSourceS3Configuration.getObjectKeyPrefix(), OBJECTKEYPREFIX_BINDING);
        } catch (Exception e) {
