...
public class NotifyApplicationStateRequestMarshaller {
    ...
    private static final NotifyApplicationStateRequestMarshaller instance = new NotifyApplicationStateRequestMarshaller();

    public static NotifyApplicationStateRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(NotifyApplicationStateRequest notifyApplicationStateRequest, ProtocolMarshaller protocolMarshaller) {
