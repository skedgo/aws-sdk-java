...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.sagemakergeospatial.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.sagemakergeospatial.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.sagemakergeospatial.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.sagemakergeospatial.model.ResourceNotFoundException(
                null);
