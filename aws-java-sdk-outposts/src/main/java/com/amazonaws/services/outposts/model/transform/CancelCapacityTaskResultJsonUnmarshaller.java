...
/**
 * CancelCapacityTaskResult JSON Unmarshaller
 */
...
public class CancelCapacityTaskResultJsonUnmarshaller implements Unmarshaller<CancelCapacityTaskResult, JsonUnmarshallerContext> {
    ...
    public CancelCapacityTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelCapacityTaskResult cancelCapacityTaskResult = new CancelCapacityTaskResult();
