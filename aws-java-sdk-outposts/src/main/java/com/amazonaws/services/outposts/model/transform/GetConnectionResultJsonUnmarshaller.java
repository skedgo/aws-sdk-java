        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ConnectionId", targetDepth)) {
                    context.nextToken();
                    getConnectionResult.setConnectionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ConnectionDetails", targetDepth)) {
                    context.nextToken();
                    getConnectionResult.setConnectionDetails(ConnectionDetailsJsonUnmarshaller.getInstance().unmarshall(context));
                }
