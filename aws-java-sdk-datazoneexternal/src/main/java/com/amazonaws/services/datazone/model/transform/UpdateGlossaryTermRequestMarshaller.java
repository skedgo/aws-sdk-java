...
public class UpdateGlossaryTermRequestMarshaller {
    ...
    private static final UpdateGlossaryTermRequestMarshaller instance = new UpdateGlossaryTermRequestMarshaller();

    public static UpdateGlossaryTermRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateGlossaryTermRequest updateGlossaryTermRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateGlossaryTermRequest.getDomainIdentifier(), DOMAINIDENTIFIER_BINDING);
            protocolMarshaller.marshall(updateGlossaryTermRequest.getGlossaryIdentifier(), GLOSSARYIDENTIFIER_BINDING);
            protocolMarshaller.marshall(updateGlossaryTermRequest.getIdentifier(), IDENTIFIER_BINDING);
            protocolMarshaller.marshall(updateGlossaryTermRequest.getLongDescription(), LONGDESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateGlossaryTermRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateGlossaryTermRequest.getShortDescription(), SHORTDESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateGlossaryTermRequest.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(updateGlossaryTermRequest.getTermRelations(), TERMRELATIONS_BINDING);
        } catch (Exception e) {
