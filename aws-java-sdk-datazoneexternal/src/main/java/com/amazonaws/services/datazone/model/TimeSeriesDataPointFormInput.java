 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/TimeSeriesDataPointFormInput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TimeSeriesDataPointFormInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public TimeSeriesDataPointFormInput withContent(String content) {
        setContent(content);
        return this;
    }
    ...
    public TimeSeriesDataPointFormInput withFormName(String formName) {
    ...
    public TimeSeriesDataPointFormInput withTimestamp(java.util.Date timestamp) {
    ...
    public TimeSeriesDataPointFormInput withTypeIdentifier(String typeIdentifier) {
    ...
    public TimeSeriesDataPointFormInput withTypeRevision(String typeRevision) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimeSeriesDataPointFormInput == false)
            return false;
    ...
    @Override
    public TimeSeriesDataPointFormInput clone() {
        try {
            return (TimeSeriesDataPointFormInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.datazone.model.transform.TimeSeriesDataPointFormInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
