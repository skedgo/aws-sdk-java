...
/**
 * DeleteRumMetricsDestinationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteRumMetricsDestinationRequestMarshaller {
    ...
    private static final DeleteRumMetricsDestinationRequestMarshaller instance = new DeleteRumMetricsDestinationRequestMarshaller();

    public static DeleteRumMetricsDestinationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteRumMetricsDestinationRequest deleteRumMetricsDestinationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteRumMetricsDestinationRequest.getAppMonitorName(), APPMONITORNAME_BINDING);
            protocolMarshaller.marshall(deleteRumMetricsDestinationRequest.getDestination(), DESTINATION_BINDING);
            protocolMarshaller.marshall(deleteRumMetricsDestinationRequest.getDestinationArn(), DESTINATIONARN_BINDING);
        } catch (Exception e) {
