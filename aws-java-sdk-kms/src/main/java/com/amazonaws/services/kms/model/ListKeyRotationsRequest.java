...
public class ListKeyRotationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListKeyRotationsRequest clone() {
        return (ListKeyRotationsRequest) super.clone();
    }
