...
/**
 * UpdateMetricConfigurationResult JSON Unmarshaller
 */
...
public class UpdateMetricConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateMetricConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateMetricConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateMetricConfigurationResult updateMetricConfigurationResult = new UpdateMetricConfigurationResult();

        return updateMetricConfigurationResult;
    }
