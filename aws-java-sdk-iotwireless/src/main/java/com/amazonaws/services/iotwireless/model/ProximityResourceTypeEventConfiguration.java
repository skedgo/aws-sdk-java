 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotwireless-2020-11-22/ProximityResourceTypeEventConfiguration"
...
public class ProximityResourceTypeEventConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Proximity resource type event configuration object for enabling and disabling wireless device topic.
     */
    ...
    public ProximityResourceTypeEventConfiguration withSidewalk(SidewalkResourceTypeEventConfiguration sidewalk) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ProximityResourceTypeEventConfiguration == false)
            return false;
        ProximityResourceTypeEventConfiguration other = (ProximityResourceTypeEventConfiguration) obj;
    ...
    @Override
    public ProximityResourceTypeEventConfiguration clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotwireless.model.transform.ProximityResourceTypeEventConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
