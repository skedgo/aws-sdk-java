...
public class DescribeProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setProfile(DescribedProfile profile) {
    ...
    public DescribedProfile getProfile() {
        return this.profile;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeProfileResult == false)
            return false;
        DescribeProfileResult other = (DescribeProfileResult) obj;
    ...
    @Override
    public DescribeProfileResult clone() {
        try {
            return (DescribeProfileResult) super.clone();
