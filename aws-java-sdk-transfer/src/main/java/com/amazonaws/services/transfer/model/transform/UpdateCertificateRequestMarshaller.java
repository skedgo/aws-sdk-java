...
public class UpdateCertificateRequestMarshaller {
    ...
    public void marshall(UpdateCertificateRequest updateCertificateRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateCertificateRequest.getActiveDate(), ACTIVEDATE_BINDING);
            protocolMarshaller.marshall(updateCertificateRequest.getInactiveDate(), INACTIVEDATE_BINDING);
            protocolMarshaller.marshall(updateCertificateRequest.getDescription(), DESCRIPTION_BINDING);
        } catch (Exception e) {
