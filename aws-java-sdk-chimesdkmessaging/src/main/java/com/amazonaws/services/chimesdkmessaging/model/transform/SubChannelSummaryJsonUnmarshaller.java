...
/**
 * SubChannelSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SubChannelSummaryJsonUnmarshaller implements Unmarshaller<SubChannelSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SubChannelId", targetDepth)) {
                    context.nextToken();
                    subChannelSummary.setSubChannelId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MembershipCount", targetDepth)) {
                    context.nextToken();
                    subChannelSummary.setMembershipCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
