...
public class UpdateFirewallRuleRequestMarshaller {
    ...
    public void marshall(UpdateFirewallRuleRequest updateFirewallRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateFirewallRuleRequest.getFirewallDomainRedirectionAction(), FIREWALLDOMAINREDIRECTIONACTION_BINDING);
            protocolMarshaller.marshall(updateFirewallRuleRequest.getQtype(), QTYPE_BINDING);
        } catch (Exception e) {
