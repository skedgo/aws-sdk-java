...
/**
 * PutBucketVersioningRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PutBucketVersioningRequestMarshaller implements Marshaller<Request<PutBucketVersioningRequest>, PutBucketVersioningRequest> {
    ...
    public Request<PutBucketVersioningRequest> marshall(PutBucketVersioningRequest putBucketVersioningRequest) {
        ...
        Request<PutBucketVersioningRequest> request = new DefaultRequest<PutBucketVersioningRequest>(putBucketVersioningRequest, "AWSS3Control");

        request.setHttpMethod(HttpMethodName.PUT);

        if (putBucketVersioningRequest.getAccountId() != null) {
            request.addHeader("x-amz-account-id", StringUtils.fromString(putBucketVersioningRequest.getAccountId()));
        }

        if (putBucketVersioningRequest.getMFA() != null) {
            request.addHeader("x-amz-mfa", StringUtils.fromString(putBucketVersioningRequest.getMFA()));
        }

        String uriResourcePath = "/v20180820/bucket/{name}/versioning";

        uriResourcePath = com.amazonaws.transform.PathMarshallers.NON_GREEDY.marshall(uriResourcePath, "name", putBucketVersioningRequest.getBucket());
