...
public class CancelDomainConfigChangeRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * When set to <b>True</b>, returns the list of change IDs and properties that will be cancelled without actually
     ...
     * </p>
     * 
     * @return Name of the OpenSearch Service domain configuration request to cancel.
     */
     ...
     * 
     * @param dryRun
     *        When set to <b>True</b>, returns the list of change IDs and properties that will be cancelled without
     ...
     * </p>
     * 
     * @return When set to <b>True</b>, returns the list of change IDs and properties that will be cancelled without
     *         actually cancelling the change.
     */
