...
/**
 * ListOriginAccessControlsResult StAX Unmarshaller
 */
...
public class ListOriginAccessControlsResultStaxUnmarshaller implements Unmarshaller<ListOriginAccessControlsResult, StaxUnmarshallerContext> {
    ...
    public ListOriginAccessControlsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("OriginAccessControlList", targetDepth)) {
                    listOriginAccessControlsResult.setOriginAccessControlList(OriginAccessControlListStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
