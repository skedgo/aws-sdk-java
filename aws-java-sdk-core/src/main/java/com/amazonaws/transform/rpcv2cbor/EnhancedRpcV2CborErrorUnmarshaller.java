...
/**
 * A JSON error unmarshaller that can unmarshall from a {@link RpcV2CborUnmarshallerContext} instead of a {@code JsonNode}.
 */
@SdkInternalApi
public abstract class EnhancedRpcV2CborErrorUnmarshaller extends JsonErrorUnmarshaller {
     ...
     */
    public EnhancedRpcV2CborErrorUnmarshaller(Class<? extends AmazonServiceException> exceptionClass, String handledErrorCode) {
        super(exceptionClass, handledErrorCode);
    }

    public abstract AmazonServiceException unmarshallFromContext(RpcV2CborUnmarshallerContext context) throws Exception;
}
