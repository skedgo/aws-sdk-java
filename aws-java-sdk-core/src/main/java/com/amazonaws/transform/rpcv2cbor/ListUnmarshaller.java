...
public class ListUnmarshaller<T> implements
        Unmarshaller<List<T>, RpcV2CborUnmarshallerContext> {

    private final Unmarshaller<T, RpcV2CborUnmarshallerContext> itemUnmarshaller;

    public ListUnmarshaller(
            Unmarshaller<T, RpcV2CborUnmarshallerContext> itemUnmarshaller) {
    ...
    public List<T> unmarshall(RpcV2CborUnmarshallerContext context) throws Exception {
        ...
        return unmarshallRpcV2CborToList(context);
    }
    ...
    private List<T> unmarshallResponseHeaderToList(
            RpcV2CborUnmarshallerContext context) throws Exception {
        ...
        for (final String headerVal : headerValues) {
            list.add(itemUnmarshaller.unmarshall(new RpcV2CborUnmarshallerContext() {
                @Override
    ...
    /**
     * Unmarshalls the current token in the RpcV2Cbor document to list.
     */
    private List<T> unmarshallRpcV2CborToList(RpcV2CborUnmarshallerContext context)
            throws Exception {
        List<T> list = new ArrayList<T>();
