...
public final class BoundedCache<K, V>  {
    ...
    private BoundedCache(Builder<K, V> b) {
        ...
        this.maxCacheSize = b.maxSize != null ?
                ValidationUtils.assertIsPositive(b.maxSize, "maxSize") : DEFAULT_CACHE_SIZE;
        this.evictionBatchSize = b.evictionBatchSize != null ?
                ValidationUtils.assertIsPositive(b.evictionBatchSize, "evictionBatchSize") :
     ...
     * Otherwise, the value is calculated based on the supplied function {@link Builder#mappingFunction(Function)}.
     */
    public V get(K key) {
        ValidationUtils.assertNotNull(key, "key");
    ...
    public static <K, V> BoundedCache.Builder builder() {
        return new Builder<K, V>();
    }

    public static final class Builder<K, V> {

        private Function<K, V> mappingFunction;
        ...
        public Builder<K, V> mappingFunction(Function<K, V> mappingFunction) {
