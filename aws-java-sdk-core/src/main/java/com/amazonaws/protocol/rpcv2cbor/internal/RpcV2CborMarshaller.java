 ...
 */
@SdkInternalApi
public interface RpcV2CborMarshaller<T> {

    RpcV2CborMarshaller<Void> NULL = new RpcV2CborMarshaller<Void>() {
        @Override
        public void marshall(Void val, RpcV2CborMarshallerContext context, MarshallingInfo marshallingInfo) {
        }
    };
