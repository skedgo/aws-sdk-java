 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/apptest-2022-12-06/CompareDataSetsSummary" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CompareDataSetsSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public CompareDataSetsStepInput getStepInput() {
    ...
    public void setStepOutput(CompareDataSetsStepOutput stepOutput) {
    ...
    public CompareDataSetsStepOutput getStepOutput() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CompareDataSetsSummary == false)
            return false;
    ...
    @Override
    public CompareDataSetsSummary clone() {
        try {
            return (CompareDataSetsSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.apptest.model.transform.CompareDataSetsSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
