...
public class DataSetMarshaller {
    ...
    private static final MarshallingInfo<String> CCSID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("ccsid").build();
    ...
    public void marshall(DataSet dataSet, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(dataSet.getCcsid(), CCSID_BINDING);
            protocolMarshaller.marshall(dataSet.getFormat(), FORMAT_BINDING);
            protocolMarshaller.marshall(dataSet.getLength(), LENGTH_BINDING);
        } catch (Exception e) {
