...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.controlcatalog.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.controlcatalog.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.controlcatalog.model.ThrottlingException throttlingException = new com.amazonaws.services.controlcatalog.model.ThrottlingException(
                null);
