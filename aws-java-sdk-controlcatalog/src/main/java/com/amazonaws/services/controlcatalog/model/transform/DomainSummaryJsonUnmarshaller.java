        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("CreateTime", targetDepth)) {
                    context.nextToken();
                    domainSummary.setCreateTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                ...
                if (context.testExpression("LastUpdateTime", targetDepth)) {
                    context.nextToken();
                    domainSummary.setLastUpdateTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
