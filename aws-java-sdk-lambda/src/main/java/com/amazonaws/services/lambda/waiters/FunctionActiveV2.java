...
class FunctionActiveV2 {
    ...
    static class IsActiveMatcher extends WaiterAcceptor<GetFunctionResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("Configuration"), new JmesPathField("State"));
    ...
    static class IsPendingMatcher extends WaiterAcceptor<GetFunctionResult> {
        private static final JsonNode expectedResult;
