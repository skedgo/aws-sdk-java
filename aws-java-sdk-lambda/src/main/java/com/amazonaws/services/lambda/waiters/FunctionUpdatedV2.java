...
class FunctionUpdatedV2 {
    ...
    static class IsSuccessfulMatcher extends WaiterAcceptor<GetFunctionResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("Configuration"), new JmesPathField("LastUpdateStatus"));
    ...
    static class IsFailedMatcher extends WaiterAcceptor<GetFunctionResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsInProgressMatcher extends WaiterAcceptor<GetFunctionResult> {
        private static final JsonNode expectedResult;
