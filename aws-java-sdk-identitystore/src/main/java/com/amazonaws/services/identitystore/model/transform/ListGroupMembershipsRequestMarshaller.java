...
public class ListGroupMembershipsRequestMarshaller {
    ...
    public void marshall(ListGroupMembershipsRequest listGroupMembershipsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listGroupMembershipsRequest.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(listGroupMembershipsRequest.getGroupId(), GROUPID_BINDING);
