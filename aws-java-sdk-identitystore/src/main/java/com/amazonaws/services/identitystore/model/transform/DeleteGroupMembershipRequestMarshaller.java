...
public class DeleteGroupMembershipRequestMarshaller {
    ...
    public void marshall(DeleteGroupMembershipRequest deleteGroupMembershipRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteGroupMembershipRequest.getIdentityStoreId(), IDENTITYSTOREID_BINDING);
            protocolMarshaller.marshall(deleteGroupMembershipRequest.getMembershipId(), MEMBERSHIPID_BINDING);
        } catch (Exception e) {
