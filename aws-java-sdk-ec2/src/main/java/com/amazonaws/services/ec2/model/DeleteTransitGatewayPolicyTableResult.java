...
public class DeleteTransitGatewayPolicyTableResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return Provides details about the deleted transit gateway policy table.
     */
    ...
    public DeleteTransitGatewayPolicyTableResult withTransitGatewayPolicyTable(TransitGatewayPolicyTable transitGatewayPolicyTable) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTransitGatewayPolicyTableResult == false)
            return false;
        DeleteTransitGatewayPolicyTableResult other = (DeleteTransitGatewayPolicyTableResult) obj;
    ...
    @Override
    public DeleteTransitGatewayPolicyTableResult clone() {
        try {
            return (DeleteTransitGatewayPolicyTableResult) super.clone();
