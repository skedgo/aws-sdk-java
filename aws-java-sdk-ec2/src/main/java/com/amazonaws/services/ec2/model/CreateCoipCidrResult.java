...
public class CreateCoipCidrResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCoipCidrResult == false)
            return false;
        CreateCoipCidrResult other = (CreateCoipCidrResult) obj;
    ...
    public CreateCoipCidrResult clone() {
        try {
            return (CreateCoipCidrResult) super.clone();
