 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/RequestFilterPortRange" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RequestFilterPortRange implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RequestFilterPortRange == false)
            return false;
        RequestFilterPortRange other = (RequestFilterPortRange) obj;
    ...
    public RequestFilterPortRange clone() {
        try {
            return (RequestFilterPortRange) super.clone();
