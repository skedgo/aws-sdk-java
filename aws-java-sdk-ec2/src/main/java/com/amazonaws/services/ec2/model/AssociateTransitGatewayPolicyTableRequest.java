...
import com.amazonaws.services.ec2.model.transform.AssociateTransitGatewayPolicyTableRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssociateTransitGatewayPolicyTableRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<AssociateTransitGatewayPolicyTableRequest> {
     ...
     * </p>
     * 
     * @return The ID of the transit gateway policy table to associate with the transit gateway attachment.
     */
     ...
     * </p>
     * 
     * @return The ID of the transit gateway attachment to associate with the policy table.
     */
     ...
     */
    @Override
    public Request<AssociateTransitGatewayPolicyTableRequest> getDryRunRequest() {
        Request<AssociateTransitGatewayPolicyTableRequest> request = new AssociateTransitGatewayPolicyTableRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateTransitGatewayPolicyTableRequest == false)
            return false;
        AssociateTransitGatewayPolicyTableRequest other = (AssociateTransitGatewayPolicyTableRequest) obj;
    ...
    public AssociateTransitGatewayPolicyTableRequest clone() {
        return (AssociateTransitGatewayPolicyTableRequest) super.clone();
    }
}
