...
public class CreateIpamExternalResourceVerificationTokenRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
     ...
     * </p>
     * 
     * @return The ID of the IPAM that will create the token.
     */
    ...
    public CreateIpamExternalResourceVerificationTokenRequest withTagSpecifications(java.util.Collection<TagSpecification> tagSpecifications) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateIpamExternalResourceVerificationTokenRequest == false)
            return false;
