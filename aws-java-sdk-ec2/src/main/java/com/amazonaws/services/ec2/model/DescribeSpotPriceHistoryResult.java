...
public class DescribeSpotPriceHistoryResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * <code>""</code>) or <code>null</code> when there are no more items to return.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The token to include in another request to get the next page of items. This value is an empty string (
     *         <code>""</code>) or <code>null</code> when there are no more items to return.
     */
