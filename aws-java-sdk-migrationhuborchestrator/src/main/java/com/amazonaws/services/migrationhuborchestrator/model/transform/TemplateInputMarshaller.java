...
/**
 * TemplateInputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TemplateInputMarshaller {
    ...
    private static final TemplateInputMarshaller instance = new TemplateInputMarshaller();

    public static TemplateInputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TemplateInput templateInput, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(templateInput.getInputName(), INPUTNAME_BINDING);
            protocolMarshaller.marshall(templateInput.getDataType(), DATATYPE_BINDING);
            protocolMarshaller.marshall(templateInput.getRequired(), REQUIRED_BINDING);
        } catch (Exception e) {
