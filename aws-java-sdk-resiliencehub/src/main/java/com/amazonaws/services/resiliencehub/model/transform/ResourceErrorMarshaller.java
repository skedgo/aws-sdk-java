...
public class ResourceErrorMarshaller {
    ...
    public void marshall(ResourceError resourceError, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourceError.getLogicalResourceId(), LOGICALRESOURCEID_BINDING);
            protocolMarshaller.marshall(resourceError.getPhysicalResourceId(), PHYSICALRESOURCEID_BINDING);
            protocolMarshaller.marshall(resourceError.getReason(), REASON_BINDING);
        } catch (Exception e) {
