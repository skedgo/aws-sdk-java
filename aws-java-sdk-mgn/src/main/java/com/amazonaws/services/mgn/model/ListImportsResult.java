...
public class ListImportsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ImportTask> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return List import response items.
     */

    public java.util.List<ImportTask> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<ImportTask> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<ImportTask>(items);
    }
    ...
    public ListImportsResult withItems(ImportTask... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<ImportTask>(items.length));
        }
        for (ImportTask ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListImportsResult withItems(java.util.Collection<ImportTask> items) {
        setItems(items);
        return this;
    }
     ...
     * </p>
     * 
     * @return List import response next token.
     */
