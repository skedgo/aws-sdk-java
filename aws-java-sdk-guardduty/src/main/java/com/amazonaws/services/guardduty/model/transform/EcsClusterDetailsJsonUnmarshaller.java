...
/**
 * EcsClusterDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EcsClusterDetailsJsonUnmarshaller implements Unmarshaller<EcsClusterDetails, JsonUnmarshallerContext> {

    public EcsClusterDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        EcsClusterDetails ecsClusterDetails = new EcsClusterDetails();
    ...
    private static EcsClusterDetailsJsonUnmarshaller instance;

    public static EcsClusterDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EcsClusterDetailsJsonUnmarshaller();
        return instance;
    }
}
