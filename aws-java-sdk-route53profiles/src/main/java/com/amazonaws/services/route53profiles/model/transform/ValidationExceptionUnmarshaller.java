...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.route53profiles.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.route53profiles.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.route53profiles.model.ValidationException validationException = new com.amazonaws.services.route53profiles.model.ValidationException(
                null);
