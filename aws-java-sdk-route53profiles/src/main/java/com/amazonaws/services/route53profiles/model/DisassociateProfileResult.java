...
public class DisassociateProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the <code>DisassociateProfile</code> request.
     */
    ...
    public DisassociateProfileResult withProfileAssociation(ProfileAssociation profileAssociation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateProfileResult == false)
            return false;
        DisassociateProfileResult other = (DisassociateProfileResult) obj;
    ...
    public DisassociateProfileResult clone() {
        try {
            return (DisassociateProfileResult) super.clone();
