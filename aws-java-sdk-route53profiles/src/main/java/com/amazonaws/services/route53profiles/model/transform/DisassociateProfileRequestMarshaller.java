...
public class DisassociateProfileRequestMarshaller {
    ...
    private static final DisassociateProfileRequestMarshaller instance = new DisassociateProfileRequestMarshaller();

    public static DisassociateProfileRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DisassociateProfileRequest disassociateProfileRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(disassociateProfileRequest.getProfileId(), PROFILEID_BINDING);
            protocolMarshaller.marshall(disassociateProfileRequest.getResourceId(), RESOURCEID_BINDING);
        } catch (Exception e) {
