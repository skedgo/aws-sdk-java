...
public class AssociateProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateProfileResult == false)
            return false;
        AssociateProfileResult other = (AssociateProfileResult) obj;
    ...
    public AssociateProfileResult clone() {
        try {
            return (AssociateProfileResult) super.clone();
