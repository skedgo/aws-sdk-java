...
public class ListGatewayInstancesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * Filter the list results to display only the instances associated with the selected Gateway Amazon Resource Name
     * (ARN).
     */
    private String filterArn;
    /**
     * The maximum number of results to return per API request. For example, you submit a ListInstances request with
     ...
     * 
     * @param filterArn
     *        Filter the list results to display only the instances associated with the selected Gateway Amazon Resource
     *        Name (ARN).
     */
     ...
     * (ARN).
     * 
     * @return Filter the list results to display only the instances associated with the selected Gateway Amazon
     *         Resource Name (ARN).
     */
    ...
    public ListGatewayInstancesRequest withFilterArn(String filterArn) {
     ...
     * 
     * @param maxResults
     *        The maximum number of results to return per API request. For example, you submit a ListInstances request
     ...
     * defaults to pagination with a maximum of 10 results per page.
     * 
     * @return The maximum number of results to return per API request. For example, you submit a ListInstances request
    ...
    public ListGatewayInstancesRequest withMaxResults(Integer maxResults) {
    ...
    public ListGatewayInstancesRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListGatewayInstancesRequest == false)
            return false;
    ...
    @Override
    public ListGatewayInstancesRequest clone() {
        return (ListGatewayInstancesRequest) super.clone();
    }
