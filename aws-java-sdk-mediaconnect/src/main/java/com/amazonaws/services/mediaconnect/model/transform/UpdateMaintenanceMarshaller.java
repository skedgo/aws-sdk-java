...
/**
 * UpdateMaintenanceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateMaintenanceMarshaller {
    ...
    private static final UpdateMaintenanceMarshaller instance = new UpdateMaintenanceMarshaller();

    public static UpdateMaintenanceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateMaintenance updateMaintenance, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateMaintenance.getMaintenanceDay(), MAINTENANCEDAY_BINDING);
            protocolMarshaller.marshall(updateMaintenance.getMaintenanceScheduledDate(), MAINTENANCESCHEDULEDDATE_BINDING);
            protocolMarshaller.marshall(updateMaintenance.getMaintenanceStartHour(), MAINTENANCESTARTHOUR_BINDING);
        } catch (Exception e) {
