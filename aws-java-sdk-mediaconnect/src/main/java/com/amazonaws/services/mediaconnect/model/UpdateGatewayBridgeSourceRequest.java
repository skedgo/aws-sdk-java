 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/UpdateGatewayBridgeSourceRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateGatewayBridgeSourceRequest implements Serializable, Cloneable, StructuredPojo {
    ...
    public UpdateGatewayBridgeSourceRequest withBridgeArn(String bridgeArn) {
    ...
    public UpdateGatewayBridgeSourceRequest withVpcInterfaceAttachment(VpcInterfaceAttachment vpcInterfaceAttachment) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateGatewayBridgeSourceRequest == false)
            return false;
        UpdateGatewayBridgeSourceRequest other = (UpdateGatewayBridgeSourceRequest) obj;
    ...
    @Override
    public UpdateGatewayBridgeSourceRequest clone() {
        try {
            return (UpdateGatewayBridgeSourceRequest) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconnect.model.transform.UpdateGatewayBridgeSourceRequestMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
