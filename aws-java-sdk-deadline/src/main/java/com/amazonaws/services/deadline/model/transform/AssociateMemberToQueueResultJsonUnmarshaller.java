...
/**
 * AssociateMemberToQueueResult JSON Unmarshaller
 */
...
public class AssociateMemberToQueueResultJsonUnmarshaller implements Unmarshaller<AssociateMemberToQueueResult, JsonUnmarshallerContext> {
    ...
    public AssociateMemberToQueueResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateMemberToQueueResult associateMemberToQueueResult = new AssociateMemberToQueueResult();
