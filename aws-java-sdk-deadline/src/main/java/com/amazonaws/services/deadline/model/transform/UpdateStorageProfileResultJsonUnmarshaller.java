...
/**
 * UpdateStorageProfileResult JSON Unmarshaller
 */
...
public class UpdateStorageProfileResultJsonUnmarshaller implements Unmarshaller<UpdateStorageProfileResult, JsonUnmarshallerContext> {
    ...
    public UpdateStorageProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateStorageProfileResult updateStorageProfileResult = new UpdateStorageProfileResult();
