...
/**
 * UpdateStepRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateStepRequestMarshaller {
    ...
    private static final UpdateStepRequestMarshaller instance = new UpdateStepRequestMarshaller();

    public static UpdateStepRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateStepRequest updateStepRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateStepRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(updateStepRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(updateStepRequest.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(updateStepRequest.getQueueId(), QUEUEID_BINDING);
            protocolMarshaller.marshall(updateStepRequest.getStepId(), STEPID_BINDING);
            protocolMarshaller.marshall(updateStepRequest.getTargetTaskRunStatus(), TARGETTASKRUNSTATUS_BINDING);
        } catch (Exception e) {
