...
public class ListFleetsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> DISPLAYNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("displayName").build();
    ...
    public void marshall(ListFleetsRequest listFleetsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listFleetsRequest.getDisplayName(), DISPLAYNAME_BINDING);
            protocolMarshaller.marshall(listFleetsRequest.getFarmId(), FARMID_BINDING);
            ...
            protocolMarshaller.marshall(listFleetsRequest.getPrincipalId(), PRINCIPALID_BINDING);
            protocolMarshaller.marshall(listFleetsRequest.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
