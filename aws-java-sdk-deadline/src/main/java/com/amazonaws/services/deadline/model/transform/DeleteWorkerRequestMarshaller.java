...
public class DeleteWorkerRequestMarshaller {
    ...
    public void marshall(DeleteWorkerRequest deleteWorkerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteWorkerRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(deleteWorkerRequest.getFleetId(), FLEETID_BINDING);
            protocolMarshaller.marshall(deleteWorkerRequest.getWorkerId(), WORKERID_BINDING);
        } catch (Exception e) {
