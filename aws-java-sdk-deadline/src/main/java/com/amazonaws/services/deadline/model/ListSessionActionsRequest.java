...
public class ListSessionActionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The farm ID for the session actions list.
     */
     ...
     * </p>
     * 
     * @return The job ID for the session actions list.
     */
    ...
    public ListSessionActionsRequest withMaxResults(Integer maxResults) {
    ...
    public ListSessionActionsRequest withNextToken(String nextToken) {
     ...
     * </p>
     * 
     * @return The queue ID for the session actions list.
     */
     ...
     * </p>
     * 
     * @return The session ID to include on the sessions action list.
     */
     ...
     * </p>
     * 
     * @return The task ID for the session actions list.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSessionActionsRequest == false)
            return false;
        ListSessionActionsRequest other = (ListSessionActionsRequest) obj;
