...
public class ListStepsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The farm ID to include on the list of steps.
     */
     ...
     * </p>
     * 
     * @return The job ID to include on the list of steps.
     */
    ...
    public ListStepsRequest withMaxResults(Integer maxResults) {
    ...
    public ListStepsRequest withNextToken(String nextToken) {
     ...
     * </p>
     * 
     * @return The queue ID to include on the list of steps.
     */
