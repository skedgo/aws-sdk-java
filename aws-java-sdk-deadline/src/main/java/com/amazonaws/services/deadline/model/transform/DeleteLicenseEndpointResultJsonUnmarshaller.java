...
/**
 * DeleteLicenseEndpointResult JSON Unmarshaller
 */
...
public class DeleteLicenseEndpointResultJsonUnmarshaller implements Unmarshaller<DeleteLicenseEndpointResult, JsonUnmarshallerContext> {
    ...
    public DeleteLicenseEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLicenseEndpointResult deleteLicenseEndpointResult = new DeleteLicenseEndpointResult();
