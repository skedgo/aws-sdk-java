...
/**
 * DeleteMeteredProductResult JSON Unmarshaller
 */
...
public class DeleteMeteredProductResultJsonUnmarshaller implements Unmarshaller<DeleteMeteredProductResult, JsonUnmarshallerContext> {
    ...
    public DeleteMeteredProductResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMeteredProductResult deleteMeteredProductResult = new DeleteMeteredProductResult();
