        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("avg", targetDepth)) {
                    context.nextToken();
                    stats.setAvg(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("max", targetDepth)) {
                    context.nextToken();
                    stats.setMax(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("min", targetDepth)) {
                    context.nextToken();
                    stats.setMin(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("sum", targetDepth)) {
                    context.nextToken();
                    stats.setSum(context.getUnmarshaller(Double.class).unmarshall(context));
                }
