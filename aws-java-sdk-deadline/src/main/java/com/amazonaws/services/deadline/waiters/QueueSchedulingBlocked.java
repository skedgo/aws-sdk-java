...
class QueueSchedulingBlocked {
    ...
    static class IsSCHEDULING_BLOCKEDMatcher extends WaiterAcceptor<GetQueueResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"SCHEDULING_BLOCKED\"");
