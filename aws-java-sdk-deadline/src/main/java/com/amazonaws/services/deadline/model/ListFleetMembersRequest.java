...
public class ListFleetMembersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The farm ID of the fleet.
     */
    ...
    public ListFleetMembersRequest withFarmId(String farmId) {
        setFarmId(farmId);
        return this;
    }
     ...
     * </p>
     * 
     * @return The fleet ID to include on the list.
     */
    ...
    public ListFleetMembersRequest withFleetId(String fleetId) {
        setFleetId(fleetId);
        return this;
    }
    ...
    public ListFleetMembersRequest withMaxResults(Integer maxResults) {
    ...
    public ListFleetMembersRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFleetMembersRequest == false)
            return false;
        ListFleetMembersRequest other = (ListFleetMembersRequest) obj;
    ...
    @Override
    public ListFleetMembersRequest clone() {
        return (ListFleetMembersRequest) super.clone();
    }
