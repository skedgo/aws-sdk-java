...
public class ListAvailableMeteredProductsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAvailableMeteredProductsRequest withMaxResults(Integer maxResults) {
    ...
    public ListAvailableMeteredProductsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAvailableMeteredProductsRequest == false)
            return false;
        ListAvailableMeteredProductsRequest other = (ListAvailableMeteredProductsRequest) obj;
    ...
    @Override
    public ListAvailableMeteredProductsRequest clone() {
        return (ListAvailableMeteredProductsRequest) super.clone();
    }
