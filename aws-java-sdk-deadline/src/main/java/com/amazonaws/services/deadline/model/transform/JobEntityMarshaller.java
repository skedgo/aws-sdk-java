...
@SdkInternalApi
public class JobEntityMarshaller {
    ...
    private static final JobEntityMarshaller instance = new JobEntityMarshaller();

    public static JobEntityMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(JobEntity jobEntity, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(jobEntity.getJobAttachmentDetails(), JOBATTACHMENTDETAILS_BINDING);
            protocolMarshaller.marshall(jobEntity.getJobDetails(), JOBDETAILS_BINDING);
        } catch (Exception e) {
