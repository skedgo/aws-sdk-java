...
public class ListMeteredProductsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The license endpoint ID to include on the list of metered products.
     */
    ...
    public ListMeteredProductsRequest withMaxResults(Integer maxResults) {
    ...
    public ListMeteredProductsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListMeteredProductsRequest == false)
            return false;
        ListMeteredProductsRequest other = (ListMeteredProductsRequest) obj;
    ...
    @Override
    public ListMeteredProductsRequest clone() {
