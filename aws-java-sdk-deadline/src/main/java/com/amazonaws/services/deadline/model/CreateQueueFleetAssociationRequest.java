...
public class CreateQueueFleetAssociationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the farm that the queue and fleet belong to.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateQueueFleetAssociationRequest == false)
            return false;
        CreateQueueFleetAssociationRequest other = (CreateQueueFleetAssociationRequest) obj;
    ...
    public CreateQueueFleetAssociationRequest clone() {
        return (CreateQueueFleetAssociationRequest) super.clone();
    }
