...
public class ListFleetMembersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<FleetMember> members;
    /**
     * <p>
    ...
    public java.util.List<FleetMember> getMembers() {
        return members;
    }
    ...
    public void setMembers(java.util.Collection<FleetMember> members) {
        if (members == null) {
            this.members = null;
            return;
        }

        this.members = new java.util.ArrayList<FleetMember>(members);
    }
    ...
    public ListFleetMembersResult withMembers(FleetMember... members) {
        if (this.members == null) {
            setMembers(new java.util.ArrayList<FleetMember>(members.length));
        }
        for (FleetMember ele : members) {
    ...
    public ListFleetMembersResult withMembers(java.util.Collection<FleetMember> members) {
        setMembers(members);
        return this;
    }
    ...
    public ListFleetMembersResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFleetMembersResult == false)
            return false;
        ListFleetMembersResult other = (ListFleetMembersResult) obj;
    ...
    @Override
    public ListFleetMembersResult clone() {
        try {
            return (ListFleetMembersResult) super.clone();
