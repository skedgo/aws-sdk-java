...
/**
 * GetJobEntityErrorMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetJobEntityErrorMarshaller {
    ...
    private static final GetJobEntityErrorMarshaller instance = new GetJobEntityErrorMarshaller();

    public static GetJobEntityErrorMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetJobEntityError getJobEntityError, ProtocolMarshaller protocolMarshaller) {

        if (getJobEntityError == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(getJobEntityError.getEnvironmentDetails(), ENVIRONMENTDETAILS_BINDING);
            protocolMarshaller.marshall(getJobEntityError.getJobAttachmentDetails(), JOBATTACHMENTDETAILS_BINDING);
            protocolMarshaller.marshall(getJobEntityError.getJobDetails(), JOBDETAILS_BINDING);
            protocolMarshaller.marshall(getJobEntityError.getStepDetails(), STEPDETAILS_BINDING);
        } catch (Exception e) {
