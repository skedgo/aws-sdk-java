...
public class ListQueueFleetAssociationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The farm ID for the queue-fleet association list.
     */
     ...
     * </p>
     * 
     * @return The fleet ID for the queue-fleet association list.
     */
    ...
    public ListQueueFleetAssociationsRequest withMaxResults(Integer maxResults) {
    ...
    public ListQueueFleetAssociationsRequest withNextToken(String nextToken) {
     ...
     * </p>
     * 
     * @return The queue ID for the queue-fleet association list.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListQueueFleetAssociationsRequest == false)
            return false;
        ListQueueFleetAssociationsRequest other = (ListQueueFleetAssociationsRequest) obj;
    ...
    @Override
    public ListQueueFleetAssociationsRequest clone() {
        return (ListQueueFleetAssociationsRequest) super.clone();
    }
