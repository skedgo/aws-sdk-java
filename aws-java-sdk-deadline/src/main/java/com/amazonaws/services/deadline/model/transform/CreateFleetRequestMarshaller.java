...
public class CreateFleetRequestMarshaller {
    ...
    public void marshall(CreateFleetRequest createFleetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createFleetRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createFleetRequest.getConfiguration(), CONFIGURATION_BINDING);
            ...
            protocolMarshaller.marshall(createFleetRequest.getFarmId(), FARMID_BINDING);
            protocolMarshaller.marshall(createFleetRequest.getMaxWorkerCount(), MAXWORKERCOUNT_BINDING);
            protocolMarshaller.marshall(createFleetRequest.getMinWorkerCount(), MINWORKERCOUNT_BINDING);
            protocolMarshaller.marshall(createFleetRequest.getRoleArn(), ROLEARN_BINDING);
