...
/**
 * QueryStagePlanNode JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class QueryStagePlanNodeJsonUnmarshaller implements Unmarshaller<QueryStagePlanNode, JsonUnmarshallerContext> {

    public QueryStagePlanNode unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static QueryStagePlanNodeJsonUnmarshaller instance;

    public static QueryStagePlanNodeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new QueryStagePlanNodeJsonUnmarshaller();
        return instance;
    }
}
