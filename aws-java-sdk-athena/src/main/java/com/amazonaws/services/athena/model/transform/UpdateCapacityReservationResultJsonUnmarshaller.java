...
/**
 * UpdateCapacityReservationResult JSON Unmarshaller
 */
...
public class UpdateCapacityReservationResultJsonUnmarshaller implements Unmarshaller<UpdateCapacityReservationResult, JsonUnmarshallerContext> {
    ...
    public UpdateCapacityReservationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateCapacityReservationResult updateCapacityReservationResult = new UpdateCapacityReservationResult();

        return updateCapacityReservationResult;
    }
