...
/**
 * SchemaShortInfoResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SchemaShortInfoResponseJsonUnmarshaller implements Unmarshaller<SchemaShortInfoResponse, JsonUnmarshallerContext> {

    public SchemaShortInfoResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        SchemaShortInfoResponse schemaShortInfoResponse = new SchemaShortInfoResponse();
    ...
    private static SchemaShortInfoResponseJsonUnmarshaller instance;

    public static SchemaShortInfoResponseJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SchemaShortInfoResponseJsonUnmarshaller();
        return instance;
    }
}
