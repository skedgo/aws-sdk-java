...
/**
 * DeleteKxClusterNodeResult JSON Unmarshaller
 */
...
public class DeleteKxClusterNodeResultJsonUnmarshaller implements Unmarshaller<DeleteKxClusterNodeResult, JsonUnmarshallerContext> {
    ...
    public DeleteKxClusterNodeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteKxClusterNodeResult deleteKxClusterNodeResult = new DeleteKxClusterNodeResult();

        return deleteKxClusterNodeResult;
    }
