...
public class ListLiveSourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * there are more than <code>MaxResults</code> live sources, use the value of <code>NextToken</code> in the response
     ...
     *        If there are more than <code>MaxResults</code> live sources, use the value of <code>NextToken</code> in
     ...
     * </p>
     * 
     * @return The maximum number of live sources that you want MediaTailor to return in response to the current
     *         request. If there are more than <code>MaxResults</code> live sources, use the value of
     ...
     * </p>
     * 
     * @return The name of the source location associated with this Live Sources list.
     */
