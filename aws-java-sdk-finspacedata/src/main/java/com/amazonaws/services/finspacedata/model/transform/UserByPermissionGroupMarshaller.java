...
/**
 * UserByPermissionGroupMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UserByPermissionGroupMarshaller {
    ...
    private static final UserByPermissionGroupMarshaller instance = new UserByPermissionGroupMarshaller();

    public static UserByPermissionGroupMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UserByPermissionGroup userByPermissionGroup, ProtocolMarshaller protocolMarshaller) {

        if (userByPermissionGroup == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(userByPermissionGroup.getUserId(), USERID_BINDING);
            protocolMarshaller.marshall(userByPermissionGroup.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(userByPermissionGroup.getFirstName(), FIRSTNAME_BINDING);
            protocolMarshaller.marshall(userByPermissionGroup.getLastName(), LASTNAME_BINDING);
            protocolMarshaller.marshall(userByPermissionGroup.getEmailAddress(), EMAILADDRESS_BINDING);
            protocolMarshaller.marshall(userByPermissionGroup.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(userByPermissionGroup.getApiAccess(), APIACCESS_BINDING);
            protocolMarshaller.marshall(userByPermissionGroup.getApiAccessPrincipalArn(), APIACCESSPRINCIPALARN_BINDING);
            protocolMarshaller.marshall(userByPermissionGroup.getMembershipStatus(), MEMBERSHIPSTATUS_BINDING);
        } catch (Exception e) {
