...
public class SrtMarshaller {
    ...
    private static final MarshallingInfo<String> PASSPHRASE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public void marshall(Srt srt, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(srt.getEndpoint(), ENDPOINT_BINDING);
            protocolMarshaller.marshall(srt.getPassphrase(), PASSPHRASE_BINDING);
        } catch (Exception e) {
