...
public class CreateIdNamespaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * defined in <code>inputSourceConfig</code> on your behalf as part of the workflow run.
     * </p>
     */
    ...
    public CreateIdNamespaceResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateIdNamespaceResult withDescription(String description) {
    ...
    public CreateIdNamespaceResult withIdMappingWorkflowProperties(IdNamespaceIdMappingWorkflowProperties... idMappingWorkflowProperties) {
    ...
    public CreateIdNamespaceResult withIdMappingWorkflowProperties(java.util.Collection<IdNamespaceIdMappingWorkflowProperties> idMappingWorkflowProperties) {
    ...
    public CreateIdNamespaceResult withIdNamespaceArn(String idNamespaceArn) {
    ...
    public CreateIdNamespaceResult withIdNamespaceName(String idNamespaceName) {
    ...
    public CreateIdNamespaceResult withInputSourceConfig(IdNamespaceInputSource... inputSourceConfig) {
    ...
    public CreateIdNamespaceResult withInputSourceConfig(java.util.Collection<IdNamespaceInputSource> inputSourceConfig) {
     ...
     *        resources defined in <code>inputSourceConfig</code> on your behalf as part of the workflow run.
     */
    ...
    public CreateIdNamespaceResult withRoleArn(String roleArn) {
        setRoleArn(roleArn);
        return this;
    }
    ...
    public CreateIdNamespaceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateIdNamespaceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateIdNamespaceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateIdNamespaceResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public CreateIdNamespaceResult withType(String type) {
        setType(type);
        return this;
    }
    ...
    public CreateIdNamespaceResult withType(IdNamespaceType type) {
    ...
    public CreateIdNamespaceResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateIdNamespaceResult == false)
            return false;
        CreateIdNamespaceResult other = (CreateIdNamespaceResult) obj;
    ...
    @Override
    public CreateIdNamespaceResult clone() {
        try {
            return (CreateIdNamespaceResult) super.clone();
