...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.controltower.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.controltower.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.controltower.model.ThrottlingException throttlingException = new com.amazonaws.services.controltower.model.ThrottlingException(
                null);
