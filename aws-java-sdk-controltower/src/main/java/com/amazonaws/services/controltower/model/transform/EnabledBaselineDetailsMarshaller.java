...
/**
 * EnabledBaselineDetailsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EnabledBaselineDetailsMarshaller {
    ...
    private static final EnabledBaselineDetailsMarshaller instance = new EnabledBaselineDetailsMarshaller();

    public static EnabledBaselineDetailsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EnabledBaselineDetails enabledBaselineDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(enabledBaselineDetails.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(enabledBaselineDetails.getBaselineIdentifier(), BASELINEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(enabledBaselineDetails.getBaselineVersion(), BASELINEVERSION_BINDING);
            protocolMarshaller.marshall(enabledBaselineDetails.getStatusSummary(), STATUSSUMMARY_BINDING);
            protocolMarshaller.marshall(enabledBaselineDetails.getTargetIdentifier(), TARGETIDENTIFIER_BINDING);
        } catch (Exception e) {
