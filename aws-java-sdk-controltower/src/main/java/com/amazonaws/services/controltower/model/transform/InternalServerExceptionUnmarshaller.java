...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.controltower.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.controltower.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.controltower.model.InternalServerException internalServerException = new com.amazonaws.services.controltower.model.InternalServerException(
                null);
