...
/**
 * DisableControlRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DisableControlRequestMarshaller {
    ...
    private static final DisableControlRequestMarshaller instance = new DisableControlRequestMarshaller();

    public static DisableControlRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DisableControlRequest disableControlRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(disableControlRequest.getControlIdentifier(), CONTROLIDENTIFIER_BINDING);
            protocolMarshaller.marshall(disableControlRequest.getTargetIdentifier(), TARGETIDENTIFIER_BINDING);
        } catch (Exception e) {
