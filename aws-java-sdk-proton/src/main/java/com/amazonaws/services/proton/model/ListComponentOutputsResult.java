...
public class ListComponentOutputsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of component Infrastructure as Code (IaC) outputs.
     */
    ...
    public ListComponentOutputsResult withOutputs(Output... outputs) {
    ...
    public ListComponentOutputsResult withOutputs(java.util.Collection<Output> outputs) {
        setOutputs(outputs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListComponentOutputsResult == false)
            return false;
        ListComponentOutputsResult other = (ListComponentOutputsResult) obj;
    ...
    public ListComponentOutputsResult clone() {
        try {
            return (ListComponentOutputsResult) super.clone();
