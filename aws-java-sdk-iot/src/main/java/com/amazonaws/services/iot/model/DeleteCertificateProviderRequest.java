...
public class DeleteCertificateProviderRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteCertificateProviderRequest withCertificateProviderName(String certificateProviderName) {
    ...
    @Override
    public DeleteCertificateProviderRequest clone() {
        return (DeleteCertificateProviderRequest) super.clone();
    }
