...
public class PutManagedInsightRulesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array that lists the rules that could not be enabled.
     */
    ...
    public PutManagedInsightRulesResult withFailures(PartialFailure... failures) {
    ...
    public PutManagedInsightRulesResult withFailures(java.util.Collection<PartialFailure> failures) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutManagedInsightRulesResult == false)
            return false;
        PutManagedInsightRulesResult other = (PutManagedInsightRulesResult) obj;
    ...
    @Override
    public PutManagedInsightRulesResult clone() {
        try {
            return (PutManagedInsightRulesResult) super.clone();
