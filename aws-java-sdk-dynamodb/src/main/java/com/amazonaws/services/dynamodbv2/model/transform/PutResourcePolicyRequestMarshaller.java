...
public class PutResourcePolicyRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> CONFIRMREMOVESELFRESOURCEACCESS_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ConfirmRemoveSelfResourceAccess").build();
    ...
    public void marshall(PutResourcePolicyRequest putResourcePolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(putResourcePolicyRequest.getExpectedRevisionId(), EXPECTEDREVISIONID_BINDING);
            protocolMarshaller.marshall(putResourcePolicyRequest.getConfirmRemoveSelfResourceAccess(), CONFIRMREMOVESELFRESOURCEACCESS_BINDING);
        } catch (Exception e) {
