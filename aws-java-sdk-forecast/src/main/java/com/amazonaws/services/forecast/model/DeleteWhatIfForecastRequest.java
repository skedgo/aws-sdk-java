...
public class DeleteWhatIfForecastRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the what-if forecast that you want to delete.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteWhatIfForecastRequest == false)
            return false;
        DeleteWhatIfForecastRequest other = (DeleteWhatIfForecastRequest) obj;
    ...
    @Override
    public DeleteWhatIfForecastRequest clone() {
        return (DeleteWhatIfForecastRequest) super.clone();
    }
