...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.supplychain.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.supplychain.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.supplychain.model.ValidationException validationException = new com.amazonaws.services.supplychain.model.ValidationException(
                null);
