...
public class GetBillOfMaterialsImportJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BillOfMaterialsImportJob getJob() {
        return this.job;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetBillOfMaterialsImportJobResult == false)
            return false;
        GetBillOfMaterialsImportJobResult other = (GetBillOfMaterialsImportJobResult) obj;
    ...
    public GetBillOfMaterialsImportJobResult clone() {
        try {
            return (GetBillOfMaterialsImportJobResult) super.clone();
