...
/**
 * ListFleetsForVehicleResult JSON Unmarshaller
 */
...
public class ListFleetsForVehicleResultJsonUnmarshaller implements Unmarshaller<ListFleetsForVehicleResult, JsonUnmarshallerContext> {
    ...
    public ListFleetsForVehicleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("fleets", targetDepth)) {
                    context.nextToken();
                    listFleetsForVehicleResult.setFleets(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listFleetsForVehicleResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
