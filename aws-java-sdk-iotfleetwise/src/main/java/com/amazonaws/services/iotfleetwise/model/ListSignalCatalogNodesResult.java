...
public class ListSignalCatalogNodesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListSignalCatalogNodesResult withNodes(Node... nodes) {
        if (this.nodes == null) {
    ...
    public ListSignalCatalogNodesResult withNodes(java.util.Collection<Node> nodes) {
        setNodes(nodes);
        return this;
    }
    ...
    public ListSignalCatalogNodesResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSignalCatalogNodesResult == false)
            return false;
        ListSignalCatalogNodesResult other = (ListSignalCatalogNodesResult) obj;
    ...
    public ListSignalCatalogNodesResult clone() {
        try {
            return (ListSignalCatalogNodesResult) super.clone();
