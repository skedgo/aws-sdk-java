...
/**
 * ObdInterface JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ObdInterfaceJsonUnmarshaller implements Unmarshaller<ObdInterface, JsonUnmarshallerContext> {

    public ObdInterface unmarshall(JsonUnmarshallerContext context) throws Exception {
        ObdInterface obdInterface = new ObdInterface();
    ...
    private static ObdInterfaceJsonUnmarshaller instance;

    public static ObdInterfaceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ObdInterfaceJsonUnmarshaller();
        return instance;
    }
}
