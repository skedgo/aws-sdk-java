...
public class ListFleetsForVehicleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of fleet IDs that the vehicle is associated with.
     */
    ...
    public ListFleetsForVehicleResult withFleets(String... fleets) {
        if (this.fleets == null) {
    ...
    public ListFleetsForVehicleResult withFleets(java.util.Collection<String> fleets) {
        setFleets(fleets);
        return this;
    }
    ...
    public ListFleetsForVehicleResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFleetsForVehicleResult == false)
            return false;
        ListFleetsForVehicleResult other = (ListFleetsForVehicleResult) obj;
    ...
    public ListFleetsForVehicleResult clone() {
        try {
            return (ListFleetsForVehicleResult) super.clone();
