...
/**
 * AssociateVehicleFleetResult JSON Unmarshaller
 */
...
public class AssociateVehicleFleetResultJsonUnmarshaller implements Unmarshaller<AssociateVehicleFleetResult, JsonUnmarshallerContext> {
    ...
    public AssociateVehicleFleetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateVehicleFleetResult associateVehicleFleetResult = new AssociateVehicleFleetResult();
