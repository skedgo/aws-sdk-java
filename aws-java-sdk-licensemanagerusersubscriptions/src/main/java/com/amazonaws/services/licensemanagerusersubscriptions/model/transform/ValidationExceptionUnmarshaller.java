...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.licensemanagerusersubscriptions.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.licensemanagerusersubscriptions.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.licensemanagerusersubscriptions.model.ValidationException validationException = new com.amazonaws.services.licensemanagerusersubscriptions.model.ValidationException(
                null);
