...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.licensemanagerusersubscriptions.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.licensemanagerusersubscriptions.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.licensemanagerusersubscriptions.model.ThrottlingException throttlingException = new com.amazonaws.services.licensemanagerusersubscriptions.model.ThrottlingException(
                null);
