...
public class ServiceQuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceQuotaExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.licensemanagerusersubscriptions.model.ServiceQuotaExceededException.class, "ServiceQuotaExceededException");
    }

    @Override
    public com.amazonaws.services.licensemanagerusersubscriptions.model.ServiceQuotaExceededException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.licensemanagerusersubscriptions.model.ServiceQuotaExceededException serviceQuotaExceededException = new com.amazonaws.services.licensemanagerusersubscriptions.model.ServiceQuotaExceededException(
                null);
