...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.licensemanagerusersubscriptions.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.licensemanagerusersubscriptions.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.licensemanagerusersubscriptions.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.licensemanagerusersubscriptions.model.AccessDeniedException(
                null);
