...
@SdkInternalApi
public class BatchPutMetricsRequestMarshaller {
    ...
    private static final BatchPutMetricsRequestMarshaller instance = new BatchPutMetricsRequestMarshaller();

    public static BatchPutMetricsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchPutMetricsRequest batchPutMetricsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(batchPutMetricsRequest.getTrialComponentName(), TRIALCOMPONENTNAME_BINDING);
            protocolMarshaller.marshall(batchPutMetricsRequest.getMetricData(), METRICDATA_BINDING);
        } catch (Exception e) {
