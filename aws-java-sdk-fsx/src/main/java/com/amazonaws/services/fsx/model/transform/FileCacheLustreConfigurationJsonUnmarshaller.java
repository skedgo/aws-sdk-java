...
/**
 * FileCacheLustreConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FileCacheLustreConfigurationJsonUnmarshaller implements Unmarshaller<FileCacheLustreConfiguration, JsonUnmarshallerContext> {

    public FileCacheLustreConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static FileCacheLustreConfigurationJsonUnmarshaller instance;

    public static FileCacheLustreConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileCacheLustreConfigurationJsonUnmarshaller();
        return instance;
    }
}
