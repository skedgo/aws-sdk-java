...
public class CancelDataRepositoryTaskRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the data repository task to cancel.
     */
    ...
    @Override
    public CancelDataRepositoryTaskRequest clone() {
        return (CancelDataRepositoryTaskRequest) super.clone();
    }
