...
public class CreateFileCacheResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public FileCacheCreating getFileCache() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateFileCacheResult == false)
            return false;
        CreateFileCacheResult other = (CreateFileCacheResult) obj;
    ...
    public CreateFileCacheResult clone() {
        try {
            return (CreateFileCacheResult) super.clone();
