...
public class DeleteAccountLinkInvitationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAccountLinkInvitationResult == false)
            return false;
        DeleteAccountLinkInvitationResult other = (DeleteAccountLinkInvitationResult) obj;
    ...
    public DeleteAccountLinkInvitationResult clone() {
        try {
            return (DeleteAccountLinkInvitationResult) super.clone();
