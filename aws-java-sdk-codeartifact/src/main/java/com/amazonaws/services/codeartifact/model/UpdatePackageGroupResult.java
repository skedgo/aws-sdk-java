...
public class UpdatePackageGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The package group and information about it after the request has been processed.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePackageGroupResult == false)
            return false;
        UpdatePackageGroupResult other = (UpdatePackageGroupResult) obj;
    ...
    public UpdatePackageGroupResult clone() {
        try {
            return (UpdatePackageGroupResult) super.clone();
