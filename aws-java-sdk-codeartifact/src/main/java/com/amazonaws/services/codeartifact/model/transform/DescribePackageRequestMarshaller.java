...
public class DescribePackageRequestMarshaller {
    ...
    public void marshall(DescribePackageRequest describePackageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describePackageRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(describePackageRequest.getDomainOwner(), DOMAINOWNER_BINDING);
            protocolMarshaller.marshall(describePackageRequest.getRepository(), REPOSITORY_BINDING);
            protocolMarshaller.marshall(describePackageRequest.getFormat(), FORMAT_BINDING);
            protocolMarshaller.marshall(describePackageRequest.getNamespace(), NAMESPACE_BINDING);
            protocolMarshaller.marshall(describePackageRequest.getPackage(), PACKAGE_BINDING);
        } catch (Exception e) {
