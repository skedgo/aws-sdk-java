...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.artifact.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.artifact.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.artifact.model.ConflictException conflictException = new com.amazonaws.services.artifact.model.ConflictException(null);
