...
public class DialogActionMarshaller {
    ...
    private static final MarshallingInfo<Boolean> SUPPRESSNEXTMESSAGE_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("suppressNextMessage").build();
    ...
    public void marshall(DialogAction dialogAction, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(dialogAction.getSuppressNextMessage(), SUPPRESSNEXTMESSAGE_BINDING);
        } catch (Exception e) {
