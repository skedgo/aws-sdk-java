...
/**
 * SlotValueOverrideMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SlotValueOverrideMarshaller {
    ...
    private static final SlotValueOverrideMarshaller instance = new SlotValueOverrideMarshaller();

    public static SlotValueOverrideMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SlotValueOverride slotValueOverride, ProtocolMarshaller protocolMarshaller) {

        if (slotValueOverride == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(slotValueOverride.getShape(), SHAPE_BINDING);
            protocolMarshaller.marshall(slotValueOverride.getValue(), VALUE_BINDING);
            protocolMarshaller.marshall(slotValueOverride.getValues(), VALUES_BINDING);
        } catch (Exception e) {
