...
public class StopBotRecommendationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopBotRecommendationResult == false)
            return false;
        StopBotRecommendationResult other = (StopBotRecommendationResult) obj;
    ...
    public StopBotRecommendationResult clone() {
        try {
            return (StopBotRecommendationResult) super.clone();
