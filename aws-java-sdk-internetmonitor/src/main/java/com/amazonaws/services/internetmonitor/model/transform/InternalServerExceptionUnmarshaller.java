...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.internetmonitor.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.internetmonitor.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.internetmonitor.model.InternalServerException internalServerException = new com.amazonaws.services.internetmonitor.model.InternalServerException(
                null);
