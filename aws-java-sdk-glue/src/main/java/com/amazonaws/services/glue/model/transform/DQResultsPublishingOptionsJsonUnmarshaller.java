...
/**
 * DQResultsPublishingOptions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DQResultsPublishingOptionsJsonUnmarshaller implements Unmarshaller<DQResultsPublishingOptions, JsonUnmarshallerContext> {

    public DQResultsPublishingOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
        DQResultsPublishingOptions dQResultsPublishingOptions = new DQResultsPublishingOptions();
    ...
    private static DQResultsPublishingOptionsJsonUnmarshaller instance;

    public static DQResultsPublishingOptionsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DQResultsPublishingOptionsJsonUnmarshaller();
        return instance;
    }
}
