...
@SdkInternalApi
public class SqlAliasMarshaller {
    ...
    private static final SqlAliasMarshaller instance = new SqlAliasMarshaller();

    public static SqlAliasMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SqlAlias sqlAlias, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sqlAlias.getFrom(), FROM_BINDING);
            protocolMarshaller.marshall(sqlAlias.getAlias(), ALIAS_BINDING);
        } catch (Exception e) {
