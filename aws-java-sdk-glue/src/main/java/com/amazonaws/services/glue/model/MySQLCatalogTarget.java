 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/MySQLCatalogTarget" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MySQLCatalogTarget implements Serializable, Cloneable, StructuredPojo {
    ...
    public MySQLCatalogTarget withInputs(java.util.Collection<String> inputs) {
        setInputs(inputs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MySQLCatalogTarget == false)
            return false;
        MySQLCatalogTarget other = (MySQLCatalogTarget) obj;
    ...
    @Override
    public MySQLCatalogTarget clone() {
        try {
            return (MySQLCatalogTarget) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.MySQLCatalogTargetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
