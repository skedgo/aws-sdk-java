...
public class CreateDeploymentRequestMarshaller {
    ...
    public void marshall(CreateDeploymentRequest createDeploymentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createDeploymentRequest.getApplicationId(), APPLICATIONID_BINDING);
            protocolMarshaller.marshall(createDeploymentRequest.getApplicationVersion(), APPLICATIONVERSION_BINDING);
            protocolMarshaller.marshall(createDeploymentRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createDeploymentRequest.getEnvironmentId(), ENVIRONMENTID_BINDING);
        } catch (Exception e) {
