...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.mainframemodernization.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.mainframemodernization.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.mainframemodernization.model.ThrottlingException throttlingException = new com.amazonaws.services.mainframemodernization.model.ThrottlingException(
                null);
