...
public class GetDifferencesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * {@link #setDifferences(java.util.Collection)} or {@link #withDifferences(java.util.Collection)} if you want to
    ...
    public GetDifferencesResult withDifferences(Difference... differences) {
        if (this.differences == null) {
            setDifferences(new java.util.ArrayList<Difference>(differences.length));
        }
        for (Difference ele : differences) {
            this.differences.add(ele);
        }
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDifferences() == null ^ this.getDifferences() == null)
            return false;
        if (other.getDifferences() != null && other.getDifferences().equals(this.getDifferences()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getDifferences() == null) ? 0 : getDifferences().hashCode());
    ...
    public GetDifferencesResult clone() {
        try {
            return (GetDifferencesResult) super.clone();
