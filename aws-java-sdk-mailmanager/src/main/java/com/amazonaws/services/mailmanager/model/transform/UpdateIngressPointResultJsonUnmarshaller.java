...
/**
 * UpdateIngressPointResult JSON Unmarshaller
 */
...
public class UpdateIngressPointResultJsonUnmarshaller implements Unmarshaller<UpdateIngressPointResult, JsonUnmarshallerContext> {
    ...
    public UpdateIngressPointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateIngressPointResult updateIngressPointResult = new UpdateIngressPointResult();
