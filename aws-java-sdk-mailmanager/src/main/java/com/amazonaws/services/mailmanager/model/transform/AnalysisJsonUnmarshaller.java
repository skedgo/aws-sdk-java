        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Analyzer", targetDepth)) {
                    context.nextToken();
                    analysis.setAnalyzer(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ResultField", targetDepth)) {
                    context.nextToken();
                    analysis.setResultField(context.getUnmarshaller(String.class).unmarshall(context));
                }
