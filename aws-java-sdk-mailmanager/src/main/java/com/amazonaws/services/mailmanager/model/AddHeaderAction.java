 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mailmanager-2023-10-17/AddHeaderAction" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AddHeaderAction implements Serializable, Cloneable, StructuredPojo {

    /**
     * <p>
     * The name of the header to add to an email. The header must be prefixed with "X-". Headers are added regardless of
     * whether the header name pre-existed in the email.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The name of the header to add to an email. The header must be prefixed with "X-". Headers are added
     *         regardless of whether the header name pre-existed in the email.
     */
     ...
     * </p>
     * 
     * @return The value of the header to add to the email.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mailmanager.model.transform.AddHeaderActionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
