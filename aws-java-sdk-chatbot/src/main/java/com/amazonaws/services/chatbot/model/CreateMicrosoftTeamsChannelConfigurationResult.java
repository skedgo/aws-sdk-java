...
public class CreateMicrosoftTeamsChannelConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMicrosoftTeamsChannelConfigurationResult == false)
            return false;
        CreateMicrosoftTeamsChannelConfigurationResult other = (CreateMicrosoftTeamsChannelConfigurationResult) obj;
    ...
    public CreateMicrosoftTeamsChannelConfigurationResult clone() {
        try {
            return (CreateMicrosoftTeamsChannelConfigurationResult) super.clone();
