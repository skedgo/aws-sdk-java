...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.chatbot.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.chatbot.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.chatbot.model.LimitExceededException limitExceededException = new com.amazonaws.services.chatbot.model.LimitExceededException(
                null);
