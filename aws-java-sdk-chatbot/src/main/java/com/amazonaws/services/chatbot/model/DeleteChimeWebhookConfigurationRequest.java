...
public class DeleteChimeWebhookConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The ARN of the ChimeWebhookConfiguration to delete.
     * 
     * @return The ARN of the ChimeWebhookConfiguration to delete.
     */
    ...
    public DeleteChimeWebhookConfigurationRequest withChatConfigurationArn(String chatConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteChimeWebhookConfigurationRequest == false)
            return false;
        DeleteChimeWebhookConfigurationRequest other = (DeleteChimeWebhookConfigurationRequest) obj;
    ...
    @Override
    public DeleteChimeWebhookConfigurationRequest clone() {
