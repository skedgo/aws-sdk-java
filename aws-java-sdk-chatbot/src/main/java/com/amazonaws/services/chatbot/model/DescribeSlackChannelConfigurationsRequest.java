...
public class DescribeSlackChannelConfigurationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeSlackChannelConfigurationsRequest withMaxResults(Integer maxResults) {
    ...
    public DescribeSlackChannelConfigurationsRequest withNextToken(String nextToken) {
     ...
     * An optional ARN of a SlackChannelConfiguration to describe.
     * 
     * @return An optional ARN of a SlackChannelConfiguration to describe.
     */
    ...
    public DescribeSlackChannelConfigurationsRequest withChatConfigurationArn(String chatConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSlackChannelConfigurationsRequest == false)
            return false;
        DescribeSlackChannelConfigurationsRequest other = (DescribeSlackChannelConfigurationsRequest) obj;
    ...
    @Override
    public DescribeSlackChannelConfigurationsRequest clone() {
        return (DescribeSlackChannelConfigurationsRequest) super.clone();
    }
