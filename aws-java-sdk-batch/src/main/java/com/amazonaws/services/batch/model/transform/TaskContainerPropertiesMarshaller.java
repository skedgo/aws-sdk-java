...
/**
 * TaskContainerPropertiesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TaskContainerPropertiesMarshaller {
    ...
    private static final TaskContainerPropertiesMarshaller instance = new TaskContainerPropertiesMarshaller();

    public static TaskContainerPropertiesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TaskContainerProperties taskContainerProperties, ProtocolMarshaller protocolMarshaller) {

        if (taskContainerProperties == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(taskContainerProperties.getCommand(), COMMAND_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getDependsOn(), DEPENDSON_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getEnvironment(), ENVIRONMENT_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getEssential(), ESSENTIAL_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getImage(), IMAGE_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getLinuxParameters(), LINUXPARAMETERS_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getLogConfiguration(), LOGCONFIGURATION_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getMountPoints(), MOUNTPOINTS_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getName(), NAME_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getPrivileged(), PRIVILEGED_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getReadonlyRootFilesystem(), READONLYROOTFILESYSTEM_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getRepositoryCredentials(), REPOSITORYCREDENTIALS_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getResourceRequirements(), RESOURCEREQUIREMENTS_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getSecrets(), SECRETS_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getUlimits(), ULIMITS_BINDING);
            protocolMarshaller.marshall(taskContainerProperties.getUser(), USER_BINDING);
        } catch (Exception e) {
