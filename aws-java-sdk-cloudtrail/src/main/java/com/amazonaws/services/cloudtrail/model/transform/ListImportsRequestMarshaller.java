...
public class ListImportsRequestMarshaller {
    ...
    public void marshall(ListImportsRequest listImportsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(listImportsRequest.getDestination(), DESTINATION_BINDING);
            protocolMarshaller.marshall(listImportsRequest.getImportStatus(), IMPORTSTATUS_BINDING);
