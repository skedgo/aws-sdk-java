...
public class SourceConfigMarshaller {
    ...
    private static final MarshallingInfo<Boolean> APPLYTOALLREGIONS_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ApplyToAllRegions").build();
    ...
    public void marshall(SourceConfig sourceConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sourceConfig.getApplyToAllRegions(), APPLYTOALLREGIONS_BINDING);
            protocolMarshaller.marshall(sourceConfig.getAdvancedEventSelectors(), ADVANCEDEVENTSELECTORS_BINDING);
        } catch (Exception e) {
