...
public class ListOrdersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListOrdersRequest withFilters(java.util.Map<String, java.util.List<String>> filters) {
        setFilters(filters);
        return this;
    }
     ...
     *
     * @see ListOrdersRequest#withFilters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ListOrdersRequest addFiltersEntry(String key, java.util.List<String> value) {
