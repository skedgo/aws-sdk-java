...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.private5g.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.private5g.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.private5g.model.InternalServerException internalServerException = new com.amazonaws.services.private5g.model.InternalServerException(
                null);
