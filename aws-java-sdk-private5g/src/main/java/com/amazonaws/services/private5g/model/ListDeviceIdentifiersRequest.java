...
public class ListDeviceIdentifiersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDeviceIdentifiersRequest withFilters(java.util.Map<String, java.util.List<String>> filters) {
        setFilters(filters);
        return this;
    }
     ...
     *
     * @see ListDeviceIdentifiersRequest#withFilters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ListDeviceIdentifiersRequest addFiltersEntry(String key, java.util.List<String> value) {
    ...
    public ListDeviceIdentifiersRequest clearFiltersEntries() {
        this.filters = null;
        return this;
    }
    ...
    public ListDeviceIdentifiersRequest withMaxResults(Integer maxResults) {
    ...
    public ListDeviceIdentifiersRequest withNetworkArn(String networkArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDeviceIdentifiersRequest == false)
            return false;
        ListDeviceIdentifiersRequest other = (ListDeviceIdentifiersRequest) obj;
    ...
    @Override
    public ListDeviceIdentifiersRequest clone() {
        return (ListDeviceIdentifiersRequest) super.clone();
    }
