...
public class HttpGatewayRouteHeader implements Serializable, Cloneable, StructuredPojo {
     ...
     * 
     * @param match
     *        An object that represents the method and value to match with the header value sent in a request. Specify
     *        one match method.
     */
     ...
     * </p>
     * 
     * @return An object that represents the method and value to match with the header value sent in a request. Specify
     *         one match method.
     */
