 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/VirtualGatewayTlsValidationContextFileTrust"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VirtualGatewayTlsValidationContextFileTrust implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VirtualGatewayTlsValidationContextFileTrust == false)
            return false;
        VirtualGatewayTlsValidationContextFileTrust other = (VirtualGatewayTlsValidationContextFileTrust) obj;
    ...
    @Override
    public VirtualGatewayTlsValidationContextFileTrust clone() {
        try {
            return (VirtualGatewayTlsValidationContextFileTrust) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.VirtualGatewayTlsValidationContextFileTrustMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
