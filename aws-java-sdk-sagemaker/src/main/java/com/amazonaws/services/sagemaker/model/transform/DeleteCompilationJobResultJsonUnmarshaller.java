...
/**
 * DeleteCompilationJobResult JSON Unmarshaller
 */
...
public class DeleteCompilationJobResultJsonUnmarshaller implements Unmarshaller<DeleteCompilationJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteCompilationJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCompilationJobResult deleteCompilationJobResult = new DeleteCompilationJobResult();

        return deleteCompilationJobResult;
    }
