...
/**
 * DeleteHubContentResult JSON Unmarshaller
 */
...
public class DeleteHubContentResultJsonUnmarshaller implements Unmarshaller<DeleteHubContentResult, JsonUnmarshallerContext> {
    ...
    public DeleteHubContentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteHubContentResult deleteHubContentResult = new DeleteHubContentResult();

        return deleteHubContentResult;
    }
