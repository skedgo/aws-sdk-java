...
public class UpdateMonitoringAlertResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getMonitoringAlertName() != null)
            sb.append("MonitoringAlertName: ").append(getMonitoringAlertName());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMonitoringAlertResult == false)
            return false;
        UpdateMonitoringAlertResult other = (UpdateMonitoringAlertResult) obj;
    ...
    public UpdateMonitoringAlertResult clone() {
        try {
            return (UpdateMonitoringAlertResult) super.clone();
