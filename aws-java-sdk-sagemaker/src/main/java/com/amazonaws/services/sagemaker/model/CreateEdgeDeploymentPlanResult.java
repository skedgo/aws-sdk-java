...
public class CreateEdgeDeploymentPlanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateEdgeDeploymentPlanResult withEdgeDeploymentPlanArn(String edgeDeploymentPlanArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateEdgeDeploymentPlanResult == false)
            return false;
        CreateEdgeDeploymentPlanResult other = (CreateEdgeDeploymentPlanResult) obj;
    ...
    @Override
    public CreateEdgeDeploymentPlanResult clone() {
        try {
