...
public class CreateClusterRequestMarshaller {
    ...
    public void marshall(CreateClusterRequest createClusterRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createClusterRequest.getInstanceGroups(), INSTANCEGROUPS_BINDING);
            protocolMarshaller.marshall(createClusterRequest.getVpcConfig(), VPCCONFIG_BINDING);
