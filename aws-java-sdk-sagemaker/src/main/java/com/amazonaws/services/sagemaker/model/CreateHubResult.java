...
public class CreateHubResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateHubResult == false)
            return false;
        CreateHubResult other = (CreateHubResult) obj;
    ...
    public CreateHubResult clone() {
        try {
            return (CreateHubResult) super.clone();
