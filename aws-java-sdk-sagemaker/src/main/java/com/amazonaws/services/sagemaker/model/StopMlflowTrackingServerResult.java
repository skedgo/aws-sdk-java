...
public class StopMlflowTrackingServerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the stopped tracking server.
     */
    ...
    public StopMlflowTrackingServerResult withTrackingServerArn(String trackingServerArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopMlflowTrackingServerResult == false)
            return false;
        StopMlflowTrackingServerResult other = (StopMlflowTrackingServerResult) obj;
    ...
    @Override
    public StopMlflowTrackingServerResult clone() {
        try {
            return (StopMlflowTrackingServerResult) super.clone();
