...
/**
 * DeleteHyperParameterTuningJobResult JSON Unmarshaller
 */
...
public class DeleteHyperParameterTuningJobResultJsonUnmarshaller implements Unmarshaller<DeleteHyperParameterTuningJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteHyperParameterTuningJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteHyperParameterTuningJobResult deleteHyperParameterTuningJobResult = new DeleteHyperParameterTuningJobResult();

        return deleteHyperParameterTuningJobResult;
    }
