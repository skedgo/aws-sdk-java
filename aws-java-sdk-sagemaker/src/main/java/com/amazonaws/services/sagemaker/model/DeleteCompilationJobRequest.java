...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteCompilationJob" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteCompilationJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the compilation job to delete.
     */
    ...
    public DeleteCompilationJobRequest withCompilationJobName(String compilationJobName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteCompilationJobRequest == false)
            return false;
        DeleteCompilationJobRequest other = (DeleteCompilationJobRequest) obj;
    ...
    @Override
    public DeleteCompilationJobRequest clone() {
        return (DeleteCompilationJobRequest) super.clone();
    }
