...
/**
 * DeleteEdgeDeploymentPlanResult JSON Unmarshaller
 */
...
public class DeleteEdgeDeploymentPlanResultJsonUnmarshaller implements Unmarshaller<DeleteEdgeDeploymentPlanResult, JsonUnmarshallerContext> {
    ...
    public DeleteEdgeDeploymentPlanResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEdgeDeploymentPlanResult deleteEdgeDeploymentPlanResult = new DeleteEdgeDeploymentPlanResult();

        return deleteEdgeDeploymentPlanResult;
    }
