        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("channel", targetDepth)) {
                    context.nextToken();
                    contactFilter.setChannel(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("contactArn", targetDepth)) {
                    context.nextToken();
                    contactFilter.setContactArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
