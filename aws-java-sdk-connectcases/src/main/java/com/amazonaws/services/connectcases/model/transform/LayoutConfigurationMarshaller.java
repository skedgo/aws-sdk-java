...
public class LayoutConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> DEFAULTLAYOUT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("defaultLayout").build();
    ...
    public void marshall(LayoutConfiguration layoutConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(layoutConfiguration.getDefaultLayout(), DEFAULTLAYOUT_BINDING);
        } catch (Exception e) {
