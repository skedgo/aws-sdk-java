...
public class ServiceQuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceQuotaExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.connectcases.model.ServiceQuotaExceededException.class, "ServiceQuotaExceededException");
    }

    @Override
    public com.amazonaws.services.connectcases.model.ServiceQuotaExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.connectcases.model.ServiceQuotaExceededException serviceQuotaExceededException = new com.amazonaws.services.connectcases.model.ServiceQuotaExceededException(
                null);
