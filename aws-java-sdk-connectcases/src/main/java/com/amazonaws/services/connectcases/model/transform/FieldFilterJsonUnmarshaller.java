...
/**
 * FieldFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FieldFilterJsonUnmarshaller implements Unmarshaller<FieldFilter, JsonUnmarshallerContext> {

    public FieldFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static FieldFilterJsonUnmarshaller instance;

    public static FieldFilterJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FieldFilterJsonUnmarshaller();
        return instance;
    }
}
