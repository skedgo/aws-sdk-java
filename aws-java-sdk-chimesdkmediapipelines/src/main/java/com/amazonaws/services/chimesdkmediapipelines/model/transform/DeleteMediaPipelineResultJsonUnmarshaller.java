...
/**
 * DeleteMediaPipelineResult JSON Unmarshaller
 */
...
public class DeleteMediaPipelineResultJsonUnmarshaller implements Unmarshaller<DeleteMediaPipelineResult, JsonUnmarshallerContext> {
    ...
    public DeleteMediaPipelineResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMediaPipelineResult deleteMediaPipelineResult = new DeleteMediaPipelineResult();

        return deleteMediaPipelineResult;
    }
