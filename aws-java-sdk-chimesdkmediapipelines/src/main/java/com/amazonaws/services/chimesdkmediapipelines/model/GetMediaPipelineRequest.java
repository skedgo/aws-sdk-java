...
public class GetMediaPipelineRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetMediaPipelineRequest withMediaPipelineId(String mediaPipelineId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMediaPipelineRequest == false)
            return false;
        GetMediaPipelineRequest other = (GetMediaPipelineRequest) obj;
    ...
    @Override
    public GetMediaPipelineRequest clone() {
        return (GetMediaPipelineRequest) super.clone();
    }
