...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-sdk-media-pipelines-2021-07-15/CreateMediaCapturePipeline"
...
public class CreateMediaCapturePipelineRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateMediaCapturePipelineRequest withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public CreateMediaCapturePipelineRequest withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
