...
public class DeleteMediaPipelineRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the media pipeline to delete.
     */
    ...
    public DeleteMediaPipelineRequest withMediaPipelineId(String mediaPipelineId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteMediaPipelineRequest == false)
            return false;
        DeleteMediaPipelineRequest other = (DeleteMediaPipelineRequest) obj;
    ...
    @Override
    public DeleteMediaPipelineRequest clone() {
        return (DeleteMediaPipelineRequest) super.clone();
    }
