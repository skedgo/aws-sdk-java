 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-realtime-2020-07-14/PublicKeySummary" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PublicKeySummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public PublicKeySummary withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see PublicKeySummary#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PublicKeySummary addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.ivsrealtime.model.transform.PublicKeySummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
