...
public class CreateDatasetRequestMarshaller {
    ...
    public void marshall(CreateDatasetRequest createDatasetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createDatasetRequest.getFlywheelArn(), FLYWHEELARN_BINDING);
            ...
            protocolMarshaller.marshall(createDatasetRequest.getInputDataConfig(), INPUTDATACONFIG_BINDING);
            protocolMarshaller.marshall(createDatasetRequest.getClientRequestToken(), CLIENTREQUESTTOKEN_BINDING);
