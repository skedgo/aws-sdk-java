...
public class AccessEntryMarshaller {
    ...
    private static final MarshallingInfo<String> ACCESSENTRYARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("accessEntryArn").build();
    ...
    public void marshall(AccessEntry accessEntry, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(accessEntry.getClusterName(), CLUSTERNAME_BINDING);
            protocolMarshaller.marshall(accessEntry.getPrincipalArn(), PRINCIPALARN_BINDING);
            protocolMarshaller.marshall(accessEntry.getKubernetesGroups(), KUBERNETESGROUPS_BINDING);
            protocolMarshaller.marshall(accessEntry.getAccessEntryArn(), ACCESSENTRYARN_BINDING);
            protocolMarshaller.marshall(accessEntry.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(accessEntry.getModifiedAt(), MODIFIEDAT_BINDING);
            protocolMarshaller.marshall(accessEntry.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(accessEntry.getUsername(), USERNAME_BINDING);
            protocolMarshaller.marshall(accessEntry.getType(), TYPE_BINDING);
        } catch (Exception e) {
