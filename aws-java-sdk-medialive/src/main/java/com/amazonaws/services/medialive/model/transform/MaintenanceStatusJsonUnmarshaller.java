...
/**
 * MaintenanceStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MaintenanceStatusJsonUnmarshaller implements Unmarshaller<MaintenanceStatus, JsonUnmarshallerContext> {

    public MaintenanceStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static MaintenanceStatusJsonUnmarshaller instance;

    public static MaintenanceStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaintenanceStatusJsonUnmarshaller();
        return instance;
    }
}
