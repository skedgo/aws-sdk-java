...
/**
 * StartInputDeviceMaintenanceWindowResult JSON Unmarshaller
 */
...
public class StartInputDeviceMaintenanceWindowResultJsonUnmarshaller implements Unmarshaller<StartInputDeviceMaintenanceWindowResult, JsonUnmarshallerContext> {
    ...
    public StartInputDeviceMaintenanceWindowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartInputDeviceMaintenanceWindowResult startInputDeviceMaintenanceWindowResult = new StartInputDeviceMaintenanceWindowResult();

        return startInputDeviceMaintenanceWindowResult;
    }
