...
public class Eac3AtmosSettingsMarshaller {
    ...
    private static final MarshallingInfo<Double> HEIGHTTRIM_BINDING = MarshallingInfo.builder(MarshallingType.DOUBLE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("heightTrim").build();
    private static final MarshallingInfo<Double> SURROUNDTRIM_BINDING = MarshallingInfo.builder(MarshallingType.DOUBLE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("surroundTrim").build();
