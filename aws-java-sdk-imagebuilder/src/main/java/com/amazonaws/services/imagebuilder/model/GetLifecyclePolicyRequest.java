...
public class GetLifecyclePolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the Amazon Resource Name (ARN) of the image lifecycle policy resource to get.
     */
    ...
    public GetLifecyclePolicyRequest withLifecyclePolicyArn(String lifecyclePolicyArn) {
