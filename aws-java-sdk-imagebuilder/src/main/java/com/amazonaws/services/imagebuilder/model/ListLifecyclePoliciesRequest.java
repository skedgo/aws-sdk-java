...
public class ListLifecyclePoliciesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * Streamline results based on one of the following values: <code>Name</code>, <code>Status</code>.
     * </p>
     */
     ...
     * </p>
     * 
     * @return Streamline results based on one of the following values: <code>Name</code>, <code>Status</code>.
     */
    ...
    public ListLifecyclePoliciesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
