...
/**
 * CIDRSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CIDRSummaryJsonUnmarshaller implements Unmarshaller<CIDRSummary, JsonUnmarshallerContext> {

    public CIDRSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        CIDRSummary cIDRSummary = new CIDRSummary();
    ...
    private static CIDRSummaryJsonUnmarshaller instance;

    public static CIDRSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CIDRSummaryJsonUnmarshaller();
        return instance;
    }
}
