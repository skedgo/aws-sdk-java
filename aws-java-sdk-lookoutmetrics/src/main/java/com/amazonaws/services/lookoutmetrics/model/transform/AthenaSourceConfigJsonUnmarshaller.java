...
/**
 * AthenaSourceConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AthenaSourceConfigJsonUnmarshaller implements Unmarshaller<AthenaSourceConfig, JsonUnmarshallerContext> {

    public AthenaSourceConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        AthenaSourceConfig athenaSourceConfig = new AthenaSourceConfig();
    ...
    private static AthenaSourceConfigJsonUnmarshaller instance;

    public static AthenaSourceConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AthenaSourceConfigJsonUnmarshaller();
        return instance;
    }
}
