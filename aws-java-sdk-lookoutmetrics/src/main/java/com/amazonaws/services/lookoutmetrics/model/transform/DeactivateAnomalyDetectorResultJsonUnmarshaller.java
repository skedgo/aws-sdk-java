...
/**
 * DeactivateAnomalyDetectorResult JSON Unmarshaller
 */
...
public class DeactivateAnomalyDetectorResultJsonUnmarshaller implements Unmarshaller<DeactivateAnomalyDetectorResult, JsonUnmarshallerContext> {
    ...
    public DeactivateAnomalyDetectorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeactivateAnomalyDetectorResult deactivateAnomalyDetectorResult = new DeactivateAnomalyDetectorResult();
