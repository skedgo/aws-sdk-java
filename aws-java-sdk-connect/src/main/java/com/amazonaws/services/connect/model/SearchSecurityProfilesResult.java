...
public class SearchSecurityProfilesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setSecurityProfiles(java.util.Collection<SecurityProfileSearchSummary> securityProfiles) {
        if (securityProfiles == null) {
            this.securityProfiles = null;
            return;
        }

        this.securityProfiles = new java.util.ArrayList<SecurityProfileSearchSummary>(securityProfiles);
    }
     ...
     * {@link #setSecurityProfiles(java.util.Collection)} or {@link #withSecurityProfiles(java.util.Collection)} if you
    ...
    public SearchSecurityProfilesResult withSecurityProfiles(SecurityProfileSearchSummary... securityProfiles) {
        if (this.securityProfiles == null) {
            setSecurityProfiles(new java.util.ArrayList<SecurityProfileSearchSummary>(securityProfiles.length));
        }
        for (SecurityProfileSearchSummary ele : securityProfiles) {
            this.securityProfiles.add(ele);
        }
        return this;
    }
    ...
    public SearchSecurityProfilesResult withSecurityProfiles(java.util.Collection<SecurityProfileSearchSummary> securityProfiles) {
     ...
     * </p>
     * 
     * @return The total number of security profiles which matched your search query.
     */
    ...
    public String toString() {
        ...
        if (getSecurityProfiles() != null)
            sb.append("SecurityProfiles: ").append(getSecurityProfiles()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSecurityProfiles() == null ^ this.getSecurityProfiles() == null)
            return false;
        if (other.getSecurityProfiles() != null && other.getSecurityProfiles().equals(this.getSecurityProfiles()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSecurityProfiles() == null) ? 0 : getSecurityProfiles().hashCode());
    ...
    public SearchSecurityProfilesResult clone() {
        try {
            return (SearchSecurityProfilesResult) super.clone();
