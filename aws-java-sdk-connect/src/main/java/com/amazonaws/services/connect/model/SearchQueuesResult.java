...
public class SearchQueuesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The total number of queues which matched your search query.
     */
    ...
    public SearchQueuesResult clone() {
        try {
            return (SearchQueuesResult) super.clone();
