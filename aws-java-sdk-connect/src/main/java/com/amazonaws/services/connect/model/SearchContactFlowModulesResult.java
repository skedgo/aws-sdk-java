...
public class SearchContactFlowModulesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The search criteria to be used to return contact flow modules.
     */
     ...
     * {@link #setContactFlowModules(java.util.Collection)} or {@link #withContactFlowModules(java.util.Collection)} if
    ...
    public SearchContactFlowModulesResult withContactFlowModules(ContactFlowModule... contactFlowModules) {
        if (this.contactFlowModules == null) {
            setContactFlowModules(new java.util.ArrayList<ContactFlowModule>(contactFlowModules.length));
        }
        for (ContactFlowModule ele : contactFlowModules) {
            this.contactFlowModules.add(ele);
        }
        return this;
    }
    ...
    public SearchContactFlowModulesResult withContactFlowModules(java.util.Collection<ContactFlowModule> contactFlowModules) {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getContactFlowModules() == null ^ this.getContactFlowModules() == null)
            return false;
        if (other.getContactFlowModules() != null && other.getContactFlowModules().equals(this.getContactFlowModules()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getContactFlowModules() == null) ? 0 : getContactFlowModules().hashCode());
