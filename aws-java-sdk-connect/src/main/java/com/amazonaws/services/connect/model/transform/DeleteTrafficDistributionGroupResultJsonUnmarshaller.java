...
/**
 * DeleteTrafficDistributionGroupResult JSON Unmarshaller
 */
...
public class DeleteTrafficDistributionGroupResultJsonUnmarshaller implements Unmarshaller<DeleteTrafficDistributionGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteTrafficDistributionGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
