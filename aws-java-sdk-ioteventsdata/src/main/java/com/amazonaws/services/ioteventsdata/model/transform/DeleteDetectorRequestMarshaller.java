...
public class DeleteDetectorRequestMarshaller {
    ...
    public void marshall(DeleteDetectorRequest deleteDetectorRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteDetectorRequest.getMessageId(), MESSAGEID_BINDING);
            protocolMarshaller.marshall(deleteDetectorRequest.getDetectorModelName(), DETECTORMODELNAME_BINDING);
            protocolMarshaller.marshall(deleteDetectorRequest.getKeyValue(), KEYVALUE_BINDING);
        } catch (Exception e) {
