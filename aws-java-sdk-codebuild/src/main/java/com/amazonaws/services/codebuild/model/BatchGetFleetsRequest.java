...
public class BatchGetFleetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The names or ARNs of the compute fleets.
     */
    ...
    public BatchGetFleetsRequest withNames(String... names) {
        if (this.names == null) {
    ...
    public BatchGetFleetsRequest withNames(java.util.Collection<String> names) {
        setNames(names);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetFleetsRequest == false)
            return false;
        BatchGetFleetsRequest other = (BatchGetFleetsRequest) obj;
    ...
    @Override
    public BatchGetFleetsRequest clone() {
        return (BatchGetFleetsRequest) super.clone();
    }
