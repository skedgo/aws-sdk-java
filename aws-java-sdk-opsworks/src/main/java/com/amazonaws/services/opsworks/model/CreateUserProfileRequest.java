...
public class CreateUserProfileRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * includes other punctuation marks, OpsWorks Stacks removes them. For example, <code>my.name</code> is changed to
     * <code>myname</code>. If you do not specify an SSH user name, OpsWorks Stacks generates one from the IAM user
     * name.
     * </p>
     */
     ...
     *        name includes other punctuation marks, OpsWorks Stacks removes them. For example, <code>my.name</code> is
     *        changed to <code>myname</code>. If you do not specify an SSH user name, OpsWorks Stacks generates one from
     *        the IAM user name.
     */
     ...
     *         specified name includes other punctuation marks, OpsWorks Stacks removes them. For example,
     *         <code>my.name</code> is changed to <code>myname</code>. If you do not specify an SSH user name, OpsWorks
