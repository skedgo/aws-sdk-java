...
public class UpdateDashboardLinksResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateDashboardLinksResult withLinkEntities(String... linkEntities) {
    ...
    public UpdateDashboardLinksResult withLinkEntities(java.util.Collection<String> linkEntities) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDashboardLinksResult == false)
            return false;
        UpdateDashboardLinksResult other = (UpdateDashboardLinksResult) obj;
    ...
    public UpdateDashboardLinksResult clone() {
        try {
            return (UpdateDashboardLinksResult) super.clone();
