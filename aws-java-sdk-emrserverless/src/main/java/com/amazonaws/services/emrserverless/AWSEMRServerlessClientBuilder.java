...
/**
 * Fluent builder for {@link com.amazonaws.services.emrserverless.AWSEMRServerless}. Use of the builder is preferred
 * over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AWSEMRServerlessClientBuilder extends AwsSyncClientBuilder<AWSEMRServerlessClientBuilder, AWSEMRServerless> {
     ...
     * @return Fully configured implementation of AWSEMRServerless.
     */
    @Override
    protected AWSEMRServerless build(AwsSyncClientParams params) {
        return new AWSEMRServerlessClient(params);
    }
