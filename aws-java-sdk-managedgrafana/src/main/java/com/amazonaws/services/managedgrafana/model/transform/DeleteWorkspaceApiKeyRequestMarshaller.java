...
public class DeleteWorkspaceApiKeyRequestMarshaller {
    ...
    private static final DeleteWorkspaceApiKeyRequestMarshaller instance = new DeleteWorkspaceApiKeyRequestMarshaller();

    public static DeleteWorkspaceApiKeyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteWorkspaceApiKeyRequest deleteWorkspaceApiKeyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteWorkspaceApiKeyRequest.getKeyName(), KEYNAME_BINDING);
            protocolMarshaller.marshall(deleteWorkspaceApiKeyRequest.getWorkspaceId(), WORKSPACEID_BINDING);
        } catch (Exception e) {
