...
public class DeleteWorkspaceServiceAccountTokenRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the service account from which to delete the token.
     */
     ...
     * </p>
     * 
     * @return The ID of the token to delete.
     */
     ...
     * </p>
     * 
     * @return The ID of the workspace from which to delete the token.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteWorkspaceServiceAccountTokenRequest == false)
            return false;
        DeleteWorkspaceServiceAccountTokenRequest other = (DeleteWorkspaceServiceAccountTokenRequest) obj;
