...
/**
 * UpdateRescoreExecutionPlanResult JSON Unmarshaller
 */
...
public class UpdateRescoreExecutionPlanResultJsonUnmarshaller implements Unmarshaller<UpdateRescoreExecutionPlanResult, JsonUnmarshallerContext> {
    ...
    public UpdateRescoreExecutionPlanResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateRescoreExecutionPlanResult updateRescoreExecutionPlanResult = new UpdateRescoreExecutionPlanResult();

        return updateRescoreExecutionPlanResult;
    }
