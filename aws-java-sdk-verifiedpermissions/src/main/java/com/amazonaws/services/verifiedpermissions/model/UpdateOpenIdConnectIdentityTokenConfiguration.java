 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/UpdateOpenIdConnectIdentityTokenConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateOpenIdConnectIdentityTokenConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public UpdateOpenIdConnectIdentityTokenConfiguration withClientIds(java.util.Collection<String> clientIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateOpenIdConnectIdentityTokenConfiguration == false)
            return false;
    ...
    public UpdateOpenIdConnectIdentityTokenConfiguration clone() {
        try {
            return (UpdateOpenIdConnectIdentityTokenConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.UpdateOpenIdConnectIdentityTokenConfigurationMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
