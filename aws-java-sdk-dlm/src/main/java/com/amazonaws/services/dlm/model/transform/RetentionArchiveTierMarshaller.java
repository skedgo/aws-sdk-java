...
/**
 * RetentionArchiveTierMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RetentionArchiveTierMarshaller {
    ...
    private static final RetentionArchiveTierMarshaller instance = new RetentionArchiveTierMarshaller();

    public static RetentionArchiveTierMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RetentionArchiveTier retentionArchiveTier, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(retentionArchiveTier.getCount(), COUNT_BINDING);
            protocolMarshaller.marshall(retentionArchiveTier.getInterval(), INTERVAL_BINDING);
            protocolMarshaller.marshall(retentionArchiveTier.getIntervalUnit(), INTERVALUNIT_BINDING);
        } catch (Exception e) {
