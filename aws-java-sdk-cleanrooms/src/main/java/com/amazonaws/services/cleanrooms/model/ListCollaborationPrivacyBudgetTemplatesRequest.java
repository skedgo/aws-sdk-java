...
public class ListCollaborationPrivacyBudgetTemplatesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListCollaborationPrivacyBudgetTemplatesRequest withCollaborationIdentifier(String collaborationIdentifier) {
    ...
    public ListCollaborationPrivacyBudgetTemplatesRequest withNextToken(String nextToken) {
    ...
    public ListCollaborationPrivacyBudgetTemplatesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCollaborationPrivacyBudgetTemplatesRequest == false)
            return false;
        ListCollaborationPrivacyBudgetTemplatesRequest other = (ListCollaborationPrivacyBudgetTemplatesRequest) obj;
    ...
    @Override
    public ListCollaborationPrivacyBudgetTemplatesRequest clone() {
        return (ListCollaborationPrivacyBudgetTemplatesRequest) super.clone();
    }
