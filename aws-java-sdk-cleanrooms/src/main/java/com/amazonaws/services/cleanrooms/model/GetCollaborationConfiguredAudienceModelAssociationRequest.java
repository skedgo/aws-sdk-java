...
public class GetCollaborationConfiguredAudienceModelAssociationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetCollaborationConfiguredAudienceModelAssociationRequest withCollaborationIdentifier(String collaborationIdentifier) {
    ...
    public GetCollaborationConfiguredAudienceModelAssociationRequest withConfiguredAudienceModelAssociationIdentifier(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCollaborationConfiguredAudienceModelAssociationRequest == false)
            return false;
        GetCollaborationConfiguredAudienceModelAssociationRequest other = (GetCollaborationConfiguredAudienceModelAssociationRequest) obj;
    ...
    @Override
    public GetCollaborationConfiguredAudienceModelAssociationRequest clone() {
