...
public class CreateServerlessCacheResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateServerlessCacheResult == false)
            return false;
        CreateServerlessCacheResult other = (CreateServerlessCacheResult) obj;
    ...
    public CreateServerlessCacheResult clone() {
        try {
            return (CreateServerlessCacheResult) super.clone();
