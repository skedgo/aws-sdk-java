...
public class ListPermissionVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListPermissionVersionsRequest withPermissionArn(String permissionArn) {
    ...
    public ListPermissionVersionsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPermissionVersionsRequest == false)
            return false;
        ListPermissionVersionsRequest other = (ListPermissionVersionsRequest) obj;
    ...
    @Override
    public ListPermissionVersionsRequest clone() {
        return (ListPermissionVersionsRequest) super.clone();
    }
