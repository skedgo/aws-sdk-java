...
public class ListApplicationProvidersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListApplicationProvidersRequest withMaxResults(Integer maxResults) {
    ...
    public ListApplicationProvidersRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListApplicationProvidersRequest == false)
            return false;
        ListApplicationProvidersRequest other = (ListApplicationProvidersRequest) obj;
    ...
    @Override
    public ListApplicationProvidersRequest clone() {
        return (ListApplicationProvidersRequest) super.clone();
    }
