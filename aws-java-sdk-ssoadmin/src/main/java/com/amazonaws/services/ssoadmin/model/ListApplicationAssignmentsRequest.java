...
public class ListApplicationAssignmentsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListApplicationAssignmentsRequest withApplicationArn(String applicationArn) {
    ...
    public ListApplicationAssignmentsRequest withMaxResults(Integer maxResults) {
    ...
    public ListApplicationAssignmentsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListApplicationAssignmentsRequest == false)
            return false;
        ListApplicationAssignmentsRequest other = (ListApplicationAssignmentsRequest) obj;
    ...
    @Override
    public ListApplicationAssignmentsRequest clone() {
        return (ListApplicationAssignmentsRequest) super.clone();
    }
