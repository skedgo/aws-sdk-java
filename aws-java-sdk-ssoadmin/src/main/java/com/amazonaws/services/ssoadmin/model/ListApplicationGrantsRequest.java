...
public class ListApplicationGrantsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Specifies the ARN of the application whose grants you want to list.
     */
    ...
    public ListApplicationGrantsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListApplicationGrantsRequest == false)
            return false;
        ListApplicationGrantsRequest other = (ListApplicationGrantsRequest) obj;
    ...
    @Override
    public ListApplicationGrantsRequest clone() {
        return (ListApplicationGrantsRequest) super.clone();
    }
