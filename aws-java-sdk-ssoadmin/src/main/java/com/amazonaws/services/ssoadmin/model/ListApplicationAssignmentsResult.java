...
public class ListApplicationAssignmentsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ApplicationAssignment> applicationAssignments;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The list of users assigned to an application.
     */

    public java.util.List<ApplicationAssignment> getApplicationAssignments() {
    ...
    public void setApplicationAssignments(java.util.Collection<ApplicationAssignment> applicationAssignments) {
        if (applicationAssignments == null) {
            this.applicationAssignments = null;
            return;
        }

        this.applicationAssignments = new java.util.ArrayList<ApplicationAssignment>(applicationAssignments);
    }
    ...
    public ListApplicationAssignmentsResult withApplicationAssignments(ApplicationAssignment... applicationAssignments) {
        if (this.applicationAssignments == null) {
            setApplicationAssignments(new java.util.ArrayList<ApplicationAssignment>(applicationAssignments.length));
        }
        for (ApplicationAssignment ele : applicationAssignments) {
    ...
    public ListApplicationAssignmentsResult withApplicationAssignments(java.util.Collection<ApplicationAssignment> applicationAssignments) {
    ...
    public ListApplicationAssignmentsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListApplicationAssignmentsResult == false)
            return false;
        ListApplicationAssignmentsResult other = (ListApplicationAssignmentsResult) obj;
    ...
    public ListApplicationAssignmentsResult clone() {
        try {
            return (ListApplicationAssignmentsResult) super.clone();
