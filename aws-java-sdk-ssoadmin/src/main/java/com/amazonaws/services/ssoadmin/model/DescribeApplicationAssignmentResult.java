...
public class DescribeApplicationAssignmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeApplicationAssignmentResult == false)
            return false;
        DescribeApplicationAssignmentResult other = (DescribeApplicationAssignmentResult) obj;
    ...
    public DescribeApplicationAssignmentResult clone() {
        try {
            return (DescribeApplicationAssignmentResult) super.clone();
