...
public class CreateRegistrationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateRegistrationRequest withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public CreateRegistrationRequest withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRegistrationRequest == false)
            return false;
        CreateRegistrationRequest other = (CreateRegistrationRequest) obj;
    ...
    public CreateRegistrationRequest clone() {
        return (CreateRegistrationRequest) super.clone();
    }
