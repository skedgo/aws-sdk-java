...
public class DeleteRegistrationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteRegistrationResult withRegistrationArn(String registrationArn) {
    ...
    public DeleteRegistrationResult withRegistrationId(String registrationId) {
    ...
    public DeleteRegistrationResult withRegistrationType(String registrationType) {
    ...
    public DeleteRegistrationResult withRegistrationStatus(String registrationStatus) {
    ...
    public DeleteRegistrationResult withRegistrationStatus(RegistrationStatus registrationStatus) {
    ...
    public DeleteRegistrationResult withCurrentVersionNumber(Long currentVersionNumber) {
    ...
    public DeleteRegistrationResult withApprovedVersionNumber(Long approvedVersionNumber) {
    ...
    public DeleteRegistrationResult withLatestDeniedVersionNumber(Long latestDeniedVersionNumber) {
    ...
    public DeleteRegistrationResult withAdditionalAttributes(java.util.Map<String, String> additionalAttributes) {
     ...
     *
     * @see DeleteRegistrationResult#withAdditionalAttributes
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DeleteRegistrationResult addAdditionalAttributesEntry(String key, String value) {
    ...
    public DeleteRegistrationResult clearAdditionalAttributesEntries() {
    ...
    public DeleteRegistrationResult withCreatedTimestamp(java.util.Date createdTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRegistrationResult == false)
            return false;
        DeleteRegistrationResult other = (DeleteRegistrationResult) obj;
    ...
    @Override
    public DeleteRegistrationResult clone() {
        try {
            return (DeleteRegistrationResult) super.clone();
