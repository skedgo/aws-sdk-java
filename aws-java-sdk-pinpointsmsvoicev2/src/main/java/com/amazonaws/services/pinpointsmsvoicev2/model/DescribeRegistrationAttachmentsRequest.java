...
public class DescribeRegistrationAttachmentsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<String> registrationAttachmentIds;
    /**
     * <p>
     * An array of RegistrationAttachmentFilter objects to filter the results.
     * </p>
     */
    private java.util.List<RegistrationAttachmentFilter> filters;
    /**
     * <p>
    ...
    public java.util.List<String> getRegistrationAttachmentIds() {
    ...
    public void setRegistrationAttachmentIds(java.util.Collection<String> registrationAttachmentIds) {
        if (registrationAttachmentIds == null) {
            this.registrationAttachmentIds = null;
            return;
        }

        this.registrationAttachmentIds = new java.util.ArrayList<String>(registrationAttachmentIds);
    }
    ...
    public DescribeRegistrationAttachmentsRequest withRegistrationAttachmentIds(String... registrationAttachmentIds) {
        if (this.registrationAttachmentIds == null) {
            setRegistrationAttachmentIds(new java.util.ArrayList<String>(registrationAttachmentIds.length));
        }
    ...
    public DescribeRegistrationAttachmentsRequest withRegistrationAttachmentIds(java.util.Collection<String> registrationAttachmentIds) {
    ...
    public java.util.List<RegistrationAttachmentFilter> getFilters() {
        return filters;
    }
    ...
    public void setFilters(java.util.Collection<RegistrationAttachmentFilter> filters) {
        if (filters == null) {
            this.filters = null;
            return;
        }

        this.filters = new java.util.ArrayList<RegistrationAttachmentFilter>(filters);
    }
    ...
    public DescribeRegistrationAttachmentsRequest withFilters(RegistrationAttachmentFilter... filters) {
        if (this.filters == null) {
            setFilters(new java.util.ArrayList<RegistrationAttachmentFilter>(filters.length));
        }
    ...
    public DescribeRegistrationAttachmentsRequest withFilters(java.util.Collection<RegistrationAttachmentFilter> filters) {
        setFilters(filters);
        return this;
    }
