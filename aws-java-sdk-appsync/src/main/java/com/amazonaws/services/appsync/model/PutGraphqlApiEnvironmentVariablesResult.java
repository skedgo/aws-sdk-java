...
public class PutGraphqlApiEnvironmentVariablesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public PutGraphqlApiEnvironmentVariablesResult withEnvironmentVariables(java.util.Map<String, String> environmentVariables) {
     ...
     *
     * @see PutGraphqlApiEnvironmentVariablesResult#withEnvironmentVariables
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PutGraphqlApiEnvironmentVariablesResult addEnvironmentVariablesEntry(String key, String value) {
    ...
    public PutGraphqlApiEnvironmentVariablesResult clearEnvironmentVariablesEntries() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutGraphqlApiEnvironmentVariablesResult == false)
            return false;
        PutGraphqlApiEnvironmentVariablesResult other = (PutGraphqlApiEnvironmentVariablesResult) obj;
    ...
    @Override
    public PutGraphqlApiEnvironmentVariablesResult clone() {
        try {
            return (PutGraphqlApiEnvironmentVariablesResult) super.clone();
