...
public class ListAppAuthorizationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAppAuthorizationsRequest withAppBundleIdentifier(String appBundleIdentifier) {
    ...
    public ListAppAuthorizationsRequest withMaxResults(Integer maxResults) {
    ...
    public ListAppAuthorizationsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAppAuthorizationsRequest == false)
            return false;
    ...
    @Override
    public ListAppAuthorizationsRequest clone() {
        return (ListAppAuthorizationsRequest) super.clone();
    }
