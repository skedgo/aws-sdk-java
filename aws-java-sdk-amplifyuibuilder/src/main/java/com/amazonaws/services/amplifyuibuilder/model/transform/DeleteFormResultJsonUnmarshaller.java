...
/**
 * DeleteFormResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteFormResultJsonUnmarshaller implements Unmarshaller<DeleteFormResult, JsonUnmarshallerContext> {

    public DeleteFormResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFormResult deleteFormResult = new DeleteFormResult();
