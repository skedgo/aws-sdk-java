...
/**
 * DeleteExtensionAssociationResult JSON Unmarshaller
 */
...
public class DeleteExtensionAssociationResultJsonUnmarshaller implements Unmarshaller<DeleteExtensionAssociationResult, JsonUnmarshallerContext> {
    ...
    public DeleteExtensionAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteExtensionAssociationResult deleteExtensionAssociationResult = new DeleteExtensionAssociationResult();

        return deleteExtensionAssociationResult;
    }
