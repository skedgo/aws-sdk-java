 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01/TagCriterionForJob" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TagCriterionForJob implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<TagCriterionPairForJob> tagValues;
    ...
    public TagCriterionForJob withComparator(String comparator) {
    ...
    public TagCriterionForJob withComparator(JobComparator comparator) {
    ...
    public java.util.List<TagCriterionPairForJob> getTagValues() {
        return tagValues;
    }
    ...
    public void setTagValues(java.util.Collection<TagCriterionPairForJob> tagValues) {
        if (tagValues == null) {
            this.tagValues = null;
            return;
        }

        this.tagValues = new java.util.ArrayList<TagCriterionPairForJob>(tagValues);
    }
    ...
    public TagCriterionForJob withTagValues(TagCriterionPairForJob... tagValues) {
        if (this.tagValues == null) {
            setTagValues(new java.util.ArrayList<TagCriterionPairForJob>(tagValues.length));
        }
        for (TagCriterionPairForJob ele : tagValues) {
    ...
    public TagCriterionForJob withTagValues(java.util.Collection<TagCriterionPairForJob> tagValues) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TagCriterionForJob == false)
            return false;
    ...
    @Override
    public TagCriterionForJob clone() {
        try {
            return (TagCriterionForJob) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.macie2.model.transform.TagCriterionForJobMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
