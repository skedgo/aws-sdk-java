...
public class UpdateAllowListResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAllowListResult == false)
            return false;
        UpdateAllowListResult other = (UpdateAllowListResult) obj;
    ...
    public UpdateAllowListResult clone() {
        try {
            return (UpdateAllowListResult) super.clone();
