        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("enabled", targetDepth)) {
                    context.nextToken();
                    provisionedThroughput.setEnabled(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("volumeThroughput", targetDepth)) {
                    context.nextToken();
                    provisionedThroughput.setVolumeThroughput(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
