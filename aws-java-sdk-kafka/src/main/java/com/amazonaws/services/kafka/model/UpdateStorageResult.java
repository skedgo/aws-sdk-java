...
public class UpdateStorageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateStorageResult withClusterArn(String clusterArn) {
    ...
    public UpdateStorageResult withClusterOperationArn(String clusterOperationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateStorageResult == false)
            return false;
        UpdateStorageResult other = (UpdateStorageResult) obj;
    ...
    @Override
    public UpdateStorageResult clone() {
        try {
            return (UpdateStorageResult) super.clone();
