        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("productCodeId", targetDepth)) {
                    context.nextToken();
                    productCode.setProductCodeId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("productCodeMode", targetDepth)) {
                    context.nextToken();
                    productCode.setProductCodeMode(context.getUnmarshaller(String.class).unmarshall(context));
                }
