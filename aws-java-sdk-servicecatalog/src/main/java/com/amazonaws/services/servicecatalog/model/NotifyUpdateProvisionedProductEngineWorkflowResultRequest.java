...
public class NotifyUpdateProvisionedProductEngineWorkflowResultRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public NotifyUpdateProvisionedProductEngineWorkflowResultRequest withOutputs(RecordOutput... outputs) {
    ...
    public NotifyUpdateProvisionedProductEngineWorkflowResultRequest withOutputs(java.util.Collection<RecordOutput> outputs) {
        setOutputs(outputs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NotifyUpdateProvisionedProductEngineWorkflowResultRequest == false)
            return false;
