...
public class ListAssociatedGroupsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListAssociatedGroupsResult withGroups(GroupSummary... groups) {
        if (this.groups == null) {
    ...
    public ListAssociatedGroupsResult withGroups(java.util.Collection<GroupSummary> groups) {
        setGroups(groups);
        return this;
    }
    ...
    public ListAssociatedGroupsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAssociatedGroupsResult == false)
            return false;
        ListAssociatedGroupsResult other = (ListAssociatedGroupsResult) obj;
    ...
    public ListAssociatedGroupsResult clone() {
        try {
            return (ListAssociatedGroupsResult) super.clone();
