...
public class CreateGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param name
     *        The name for the group. It can include any Unicode characters.</p>
     *        <p>
     *        The names for all groups in your account, across all Regions, must be unique.
     */
     ...
     * </p>
     * 
     * @return The name for the group. It can include any Unicode characters.</p>
     *         <p>
     *         The names for all groups in your account, across all Regions, must be unique.
     */
     ...
     * </p>
     * 
     * @return A list of key-value pairs to associate with the group. You can associate as many as 50 tags with a
     *         group.</p>
     *         <p>
