...
/**
 * UpdateCampaignDialerConfigResult JSON Unmarshaller
 */
...
public class UpdateCampaignDialerConfigResultJsonUnmarshaller implements Unmarshaller<UpdateCampaignDialerConfigResult, JsonUnmarshallerContext> {
    ...
    public UpdateCampaignDialerConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateCampaignDialerConfigResult updateCampaignDialerConfigResult = new UpdateCampaignDialerConfigResult();
