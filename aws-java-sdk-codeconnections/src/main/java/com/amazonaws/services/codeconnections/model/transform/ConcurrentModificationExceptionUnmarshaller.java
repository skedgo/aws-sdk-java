...
public class ConcurrentModificationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConcurrentModificationExceptionUnmarshaller() {
        super(com.amazonaws.services.codeconnections.model.ConcurrentModificationException.class, "ConcurrentModificationException");
    }

    @Override
    public com.amazonaws.services.codeconnections.model.ConcurrentModificationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeconnections.model.ConcurrentModificationException concurrentModificationException = new com.amazonaws.services.codeconnections.model.ConcurrentModificationException(
                null);
