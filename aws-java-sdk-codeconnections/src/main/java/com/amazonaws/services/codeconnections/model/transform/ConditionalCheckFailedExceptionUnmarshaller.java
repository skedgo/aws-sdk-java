...
public class ConditionalCheckFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConditionalCheckFailedExceptionUnmarshaller() {
        super(com.amazonaws.services.codeconnections.model.ConditionalCheckFailedException.class, "ConditionalCheckFailedException");
    }

    @Override
    public com.amazonaws.services.codeconnections.model.ConditionalCheckFailedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeconnections.model.ConditionalCheckFailedException conditionalCheckFailedException = new com.amazonaws.services.codeconnections.model.ConditionalCheckFailedException(
                null);
