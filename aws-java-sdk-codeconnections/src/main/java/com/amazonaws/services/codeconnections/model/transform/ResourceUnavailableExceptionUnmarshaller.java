...
public class ResourceUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceUnavailableExceptionUnmarshaller() {
        super(com.amazonaws.services.codeconnections.model.ResourceUnavailableException.class, "ResourceUnavailableException");
    }

    @Override
    public com.amazonaws.services.codeconnections.model.ResourceUnavailableException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeconnections.model.ResourceUnavailableException resourceUnavailableException = new com.amazonaws.services.codeconnections.model.ResourceUnavailableException(
                null);
