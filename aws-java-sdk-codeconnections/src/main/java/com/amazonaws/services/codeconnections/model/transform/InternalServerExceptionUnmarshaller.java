...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.codeconnections.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.codeconnections.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeconnections.model.InternalServerException internalServerException = new com.amazonaws.services.codeconnections.model.InternalServerException(
                null);
