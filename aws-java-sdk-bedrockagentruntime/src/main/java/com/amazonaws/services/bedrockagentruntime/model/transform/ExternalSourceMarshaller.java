...
/**
 * ExternalSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ExternalSourceMarshaller {

    private static final MarshallingInfo<StructuredPojo> BYTECONTENT_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("byteContent").build();
    ...
    public void marshall(ExternalSource externalSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(externalSource.getByteContent(), BYTECONTENT_BINDING);
            protocolMarshaller.marshall(externalSource.getS3Location(), S3LOCATION_BINDING);
            protocolMarshaller.marshall(externalSource.getSourceType(), SOURCETYPE_BINDING);
        } catch (Exception e) {
