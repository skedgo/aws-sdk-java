...
public class UpdateContainerServiceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateContainerServiceResult == false)
            return false;
        UpdateContainerServiceResult other = (UpdateContainerServiceResult) obj;
    ...
    @Override
    public UpdateContainerServiceResult clone() {
        try {
            return (UpdateContainerServiceResult) super.clone();
